...
function XP:CreateViewerFrame()
    ...
    -- Hamburger icon: column 0, hover row (row 1 = 1/4 to 2/4)
    menuNorm:SetTexCoord(0, 1/8, 1/4, 2/4)
    ...
    -- Hamburger icon: column 0, active/pushed row (row 2 = 2/4 to 3/4)
    menuPushed:SetTexCoord(0, 1/8, 2/4, 3/4)
    menuBtn:SetPushedTexture(menuPushed)
    local menuHl = menuBtn:CreateTexture(nil, "HIGHLIGHT")
    menuHl:SetSize(16, 16)
    menuHl:SetPoint("CENTER", menuBtn, "CENTER", 0, 0)
    menuHl:SetTexture(titleBtnPath)
    -- Hamburger icon: column 0, highlight row (row 1 = 1/4 to 2/4, same as hover)
    menuHl:SetTexCoord(0, 1/8, 1/4, 2/4)
