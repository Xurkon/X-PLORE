...
function Parser:DeriveExpansion(pathParts)
    ...
    for _, part in ipairs(pathParts) do
        local lower = part:lower()
        if lower == "classic" or lower == "vanilla" then return "CLASSIC" end
        if lower == "tbc" or lower:find("burning") then return "TBC" end
        if lower == "wotlk" or lower:find("wrath") or lower:find("lich") then return "WOTLK" end
        if lower == "cata" or lower:find("cataclysm") then return "CATA" end
        if lower == "mop" or lower:find("pandaria") then return "MOP" end
        if lower == "wod" or lower:find("draenor") then return "WOD" end
        if lower == "legion" then return "LEGION" end
        if lower == "bfa" or lower:find("azeroth") then return "BFA" end
        if lower == "shadow" or lower:find("shadowlands") then return "SHADOWLANDS" end
        if lower == "dragon" or lower:find("dragonflight") then return "DRAGONFLIGHT" end
        if lower == "tww" or lower:find("within") then return "TWW" end
    end
    return nil
end
