...
function XP:OnInitialize()
    ...
    -- Options (AceConfig) - registered if AceConfig is available
    if AceConfig and AceConfigDialog then
        AceConfig:RegisterOptionsTable("X-Plore", function() return self:GetOptionsTable() end)
        AceConfigDialog:AddToBlizOptions("X-Plore", "X-Plore")
    end
end
