...
Additional Shards can be farmed at [Blade's Edge Mountains/0 29.85,64.49]
|only if haveq(11080) or completedq(11080)
step
...
Destroy #15# Fel Cannonball Stacks |q 11023/1 |goto Blade's Edge Mountains/0 33.3,44.0
...
Wrangle #5# Aether Rays |q 11066/1 |goto Blade's Edge Mountains/0 31.6,56.4
...
Destroy #20# Monstrous Kaliri Eggs |q 11008/1 |goto Terokkar Forest 63.1,80.0
You can find more around:
[Terokkar Forest 61.3,79.9]
[Terokkar Forest 67.5,79.3]
[Terokkar Forest 68.0,85.6]
[Terokkar Forest 70.3,84.5]
step
talk Sky Sergeant Doryn##23048
...
You can find more around:
[Terokkar Forest/0 69.5,85.5]
[Terokkar Forest/0 73.2,87.9]
[Terokkar Forest/0 75.2,81.3]
[Terokkar Forest/0 69.2,74.1]
step
talk Severin##23042
accept More Shadow Dust##11006 |goto Terokkar Forest/0 64.0,66.9
step
...
collect Gezzarak's Claws##32716 |goto Terokkar Forest 69.7,74.7
You can find more around:
...
|tip This enemy is elite and may require a group.
collect Akkarai's Talons##32715 |goto Terokkar Forest 69.7,74.7
You can find more around:
[Terokkar Forest 70.1,79.5]
[Terokkar Forest 73.5,80.7]
[Terokkar Forest 70.2,83.3]
...
kill Karrog##23165
|tip This enemy is elite and may require a group.
collect Karrog's Spine##32717 |goto Terokkar Forest 69.7,74.7
You can find more around:
[Terokkar Forest 70.1,79.5]
[Terokkar Forest 73.5,80.7]
[Terokkar Forest 70.2,83.3]
...
collect Vakkiz's Scale##32718 |goto Terokkar Forest 69.7,74.7
|tip This enemy is elite and may require a group.
You can find more around:
[Terokkar Forest 70.1,79.5]
[Terokkar Forest 73.5,80.7]
...
kill Terokk##21838 |goto Terokkar Forest 66.2,77.5
|tip This enemy is elite and may require a group.
...
accept Netherwing Crystals##11015 |goto Shadowmoon Valley 66.1,86.4
accept Nethermine Flayer Hide##11016 |goto Shadowmoon Valley 66.1,86.4 |only if skill("Skinning") >= 350 |noautoaccept
accept Nethercite Ore##11018 |goto Shadowmoon Valley 66.1,86.4 |only if skill("Mining") >= 350 |noautoaccept
accept Netherdust Pollen##11017 |goto Shadowmoon Valley 66.1,86.4 |only if skill("Herbalism") >= 350 |noautoaccept
...
accept The Booterang: A Cure For The Common Worthless Peon##11055 |goto Shadowmoon Valley 66.8,86.1
...
collect 12 Fel Gland##32502 |q 11020 |goto Shadowmoon Valley 60.4,45.2
...
Poison #12# Dragonmaw Peon Camps |q 11020/1 |goto Shadowmoon Valley 73.6,80.0
|only if haveq(11020) or completedq(11020)
step
label "Discipline_Dragonmaw_Peons"
use the Booterang##32680
|tip Use it on Disobedient Dragonmaw Peons.
Discipline #20# Dragonmaw Peons |q 11055/1 |goto Shadowmoon Valley 73.6,80.0
...
collect 10 Netherwing Relic##32509 |q 11035/1 |goto Shadowmoon Valley 72.1,75.2
...
collect 40 Netherdust Pollen##32468 |q 11017/1 |goto Shadowmoon Valley 62.6,86.2
...
collect 40 Nethercite Ore##32464 |q 11018/1 |goto Shadowmoon Valley 70.0,91.4
|only if haveq(11018) or completedq(11018)
step
talk Mistress of the Mines##23149
accept Picking Up the Pieces...##11076 |goto Shadowmoon Valley 65.4,90.2
|only if rep("Netherwing") >= Friendly
step
talk Dragonmaw Foreman##23376
|tip Inside the mine.
accept Dragons are the Least of Our Problems##11077 |goto Shadowmoon Valley 65.1,87.5
|only if rep("Netherwing") >= Friendly
...
kill 15 Nethermine Flayer##23169 |q 11077/1 |goto Shadowmoon Valley 71.5,83.9
|tip Inside the mine.
|only if haveq(11077) or completedq(11077)
step
label "Kill_Nethermine_Ravagers"
kill 5 Nethermine Ravager##23326 |q 11077/2 |goto Shadowmoon Valley 71.5,83.9
|tip Inside the mine.
|only if haveq(11077) or completedq(11077)
step
...
collect 30 Netherwing Crystal##32427 |q 11015/1 |goto Shadowmoon Valley 71.5,83.9
...
talk Dragonmaw Foreman##23376
|tip Inside the mine.
turnin Dragons are the Least of Our Problems##11077 |goto Shadowmoon Valley 65.1,87.5
|only if haveq(11077) or completedq(11077)
step
talk Mistress of the Mines##23149
turnin Picking Up the Pieces...##11076 |goto Shadowmoon Valley 65.4,90.2
|only if haveq(11076) or completedq(11076)
step
...
step
talk Taskmaster Varkule Dragonbreath##23140
turnin Netherwing Crystals##11015 |goto Shadowmoon Valley 66.1,86.4 |only if haveq(11015) or completedq(11015)
turnin Nethermine Flayer Hide##11016 |goto Shadowmoon Valley 66.1,86.4 |only if haveq(11016) or completedq(11016)
turnin Nethercite Ore##11018 |goto Shadowmoon Valley 66.1,86.4 |only if haveq(11018) or completedq(11018)
turnin Netherdust Pollen##11017 |goto Shadowmoon Valley 66.1,86.4 |only if haveq(11017) or completedq(11017)
|only if haveq(11015,11016,11018,11017) or completedq(11015,11016,11018,11017)
step
talk Chief Overseer Mudlump##23291
turnin The Booterang: A Cure For The Common Worthless Peon##11055 |goto Shadowmoon Valley 66.8,86.1
|only if haveq(11055) or completedq(11055)
step
talk Overlord Mor'ghor##23139
...
step
talk Yarzill the Merc##23141
Turn in Your Netherwing Eggs |complete itemcount(32506) == 0 |goto Shadowmoon Valley 66.0,86.5
step
click Netherwing Egg
|tip They look like dark purple eggs with blue crystals on them all over Netherwing Ledge.
