...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Pandaria (10-70)\\Operation: Shieldwall",{
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Pandaria (10-70)\\Peak of Serenity\\Monk Daily Quest",{
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Pandaria (10-70)\\Peak of Serenity\\Monk Quests",{
image=ZGV.IMAGESDIR.."Serenity_Peak",
monkquest=10,
condition_valid=function() return raceclass('Monk') end,
condition_valid_msg="Monk only.",
