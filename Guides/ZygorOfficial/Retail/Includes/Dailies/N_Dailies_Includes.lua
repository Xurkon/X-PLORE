...
ZygorGuidesViewer:RegisterInclude("TWW_Choose_World_Quests",[[
		...
		'|confirm |next "Cartels_of_Undermine_WQ" |complete readyq(85805) and not ZGV.WorldQuests:QuestsQueued()
		...
		'|confirm |next "Renowned_with_the_K'aresh_Trust_WQ" |complete readyq(85109) and not ZGV.WorldQuests:QuestsQueued()
		|worldquestqueue
]])
...
--Midnight
ZygorGuidesViewer:RegisterInclude("MID_Choose_World_Quests",[[
		Choose a World Quest to Complete |confirm
		|tip With the "World Quests" guide loaded, open your world map.
		|tip Left-click on a world quest icon to select that world quest.
		|tip The guide will automatically load the steps for that world quest.
		'|confirm |next "Amani_Tribe_WQ" |complete readyq(93566) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Blood_Knights_WQ" |complete readyq(92411) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Farstriders_WQ" |complete readyq(92412) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Hara'ti_WQ" |complete readyq(89035) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Magisters_WQ" |complete readyq(92410) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Shades_of_the_Row_WQ" |complete readyq(92413) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Silvermoon_Court_WQ" |complete readyq(93811) and not ZGV.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

ZygorGuidesViewer:RegisterInclude("MID_World_Quest_Emissaries",[[
		-- if we are running queued world quests, do not move to emissary turnins
		'|confirm |next "Choose_World_Quest" |complete true |only if ZGV.WorldQuests:QuestsQueued()
	step
