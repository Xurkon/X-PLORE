...
ZygorGuidesViewer:RegisterInclude("Garrison_Small_Building",[[
		%action% |goto Lunarfall/0 46.30,59.60 |only if ZGV.Garrison_GetBuildingLocation("%building%")==18
		%action% |goto Lunarfall/0 50.40,57.30 |only if ZGV.Garrison_GetBuildingLocation("%building%")==19
		%action% |goto Lunarfall/0 51.80,63.00 |only if ZGV.Garrison_GetBuildingLocation("%building%")==20
		%action% |goto Lunarfall/0 48.50,58.70 |only if default
]])

ZygorGuidesViewer:RegisterInclude("Garrison_Finalize_Small",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 47.60,59.00 |only if ZGV.Garrison_GetBuildingLocation("%building%")==18
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 49.20,58.20 |only if ZGV.Garrison_GetBuildingLocation("%building%")==19
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 50.50,64.00 |only if ZGV.Garrison_GetBuildingLocation("%building%")==20
...
ZygorGuidesViewer:RegisterInclude("Garrison_Medium_Building",[[
		%action% |goto Lunarfall/0 34.20,48.90 |only if ZGV.Garrison_GetBuildingLocation("%building%")==22
		%action% |goto Lunarfall/0 52.20,44.80 |only if ZGV.Garrison_GetBuildingLocation("%building%")==25
		%action% |goto Lunarfall/0 34.20,48.90 |only if default
]])

ZygorGuidesViewer:RegisterInclude("Garrison_Finalize_Medium",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 36.40,49.30 |only if ZGV.Garrison_GetBuildingLocation("%building%")==22
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 50.90,47.60 |only if ZGV.Garrison_GetBuildingLocation("%building%")==25
...
ZygorGuidesViewer:RegisterInclude("Garrison_Large_Building",[[
		%action% |goto Lunarfall/0 45.00,42.80 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl(1)
		%action% |goto Lunarfall/0 45.80,39.80 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl() >= 2
		%action% |goto Lunarfall/0 39.40,58.10 |only if ZGV.Garrison_GetBuildingLocation("%building%")==24
		%action% |goto Lunarfall/0 45.00,42.80 |only if default
]])

ZygorGuidesViewer:RegisterInclude("Garrison_Finalize_Large",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 44.40,45.20 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl(1)
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 44.90,43.90 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl() >= 2
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 40.60,55.70 |only if ZGV.Garrison_GetBuildingLocation("%building%")==24
