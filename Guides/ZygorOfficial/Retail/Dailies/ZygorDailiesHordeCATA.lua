...
Click here to go to the leveling section to work on this rep |confirm |next "Leveling Guides\\Cataclysm (10-70)\\Uldum (30-70)" |only if ZGV.guidesets['LevelingHCATA']
...
step
The pre-quests for these dailies are in Uldum. You can quest through the guide, or use our Leveling Guide for help. |only if not ZGV.guidesets['LevelingHCATA']
Click here to go to the leveling section to work on this rep |confirm |next "Leveling Guides\\Cataclysm (10-70)\\Twilight Highlands (30-70)" |only if ZGV.guidesets['LevelingHCATA']
