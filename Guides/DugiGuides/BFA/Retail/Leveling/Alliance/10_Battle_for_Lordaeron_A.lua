...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Battle for Azeroth|r", "Battle for Lordaeron (10+)", "War Campaign (10-50)", "Alliance", nil, "L", nil, function()
return [[

A Hour of Reckoning |QID|53370| |N|Auto Accept|

R Stormwind Harbor |OID|51795| |N|Travel to {Stormwind Harbor} (22.38, 32.56)| |Z|84|
