...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Battle for Azeroth|r", "Battle for Lordaeron (10+)", "War Campaign (10-50)", "Horde", nil, "L", nil, function()
return [[

A Hour of Reckoning |QID|53372| |N|Auto quest at level 45| |Z|85| |NPC|132254|

R Grommash Hold |OID|51796| |N|Travel to {Grommash Hold} (48.57, 70.93)| |Z|85|
...
N Guide Complete |N|Continue to (guide:"War Campaign (10-50)")|
