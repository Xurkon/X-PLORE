local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_BFA_1_150_Skinning_A")
function Guide:Initialize()
 function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Battle for Azeroth Leveling|r", "BFA Skinning (1-175)", nil, "Alliance", nil, "P", nil, function()
return [[
...
C An Unbreakable Bone Needle |QID|52228| |N|Switch to (guide:"934(10-50)") and kill the 3rd (npc:143577) and 4th boss (npc:122968)| |I| |NPC|143577, 122968|
T An Unbreakable Bone Needle |QID|52228| |N|(npc:136061) in {Tradewinds Market} (75.66,13.39)| |Z|1161| |NPC|136061|

N Guide Complete |N|You have reach level 175 Kul Tiras Skinning quests|
]]
end) end
