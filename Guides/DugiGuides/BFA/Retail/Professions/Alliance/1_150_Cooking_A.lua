local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_BFA_1_150_Cooking_A")
function Guide:Initialize()
 function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Battle for Azeroth Leveling|r", "BFA Cooking (1-175)", nil, "Alliance", nil, "P", nil, function()
return [[
...
N 110-140 (spell:259416) |CO| |N|Rank 3 recipe can be obtain randomly from Cooking World quests and cook 40 (spell:259416)<br/><b>400 (item:154898)<br/><b>200 (item:160398) (71.22,10.69)| |Z|1161| |P|1118 140|
N Switch Guide |QID|54972| |N|Switch to (guide:"1355(50+)#1355(50+)#1355(50+)") and complete (qid:54972) quest| |QID|54972|
B 129 (item:160400) |N|Buy 120(item:160400) from (npc:154257) (37.98,52.91)| |L|160400 120| |Z|1355| |NPC|154257|
B 200 (item:160399) |N|Buy 200 (item:160399) from (npc:154257) (37.98,52.91)| |L|160399 200| |Z|1355| |NPC|154257|
N 140-155 (spell:297084) |CO| |N|Craft 15 rank 1 (spell:297084), learn the recipe from (npc:154408)<br/><b>120 (item:168645)<br/><b>45 (item:160400)<br/><b>75 (item:160399)| |Z|1355| |P|1118 155| |NPC|154257| 
N 155-175 (spell:297085) |CO| |N|Craft 15 rank 2 (spell:297085), learn the recipe from (npc:154408)<br/><b>200 (item:168645)<br/><b>75 (item:160400)<br/><b>125 (item:160399)| |Z|1355| |P|1118 175| |NPC|154257| 

N Guide Complete |N|Congratulation! You reached level 175 with the Kul Tiran Cooking profession|
]]
end) end
