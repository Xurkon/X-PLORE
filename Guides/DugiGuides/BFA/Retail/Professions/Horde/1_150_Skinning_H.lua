local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_BFA_1_150_Skinning_H")
function Guide:Initialize()
 function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Battle for Azeroth Leveling|r", "BFA Skinning (1-175)", nil, "Horde", nil, "P", nil, function()
return [[
...
N 50-175 Leveling |SK| |N|Kill (npc:123083) and use skinning to reach level 175 (52.37,79.92) (54.02,79.33) (55.13,79.04) (56.31,77.95) (57.56,75.80) (55.54,76.21) (53.66,77.68)| |Z|863| |P|1046 150| |NPC|123083|
...
C Loa Fit For A King |QID|52217| |N|Switch to (guide:"934(10-50)") and kill the 3rd (npc:143577) and collect (item:161429) and 4th boss (npc:122968)| |I| |NPC|143577, 122968|
