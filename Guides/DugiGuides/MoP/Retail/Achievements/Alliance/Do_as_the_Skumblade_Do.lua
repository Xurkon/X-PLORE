...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide({"|cffffd200Pandaria|r", "|cffffd200Exploration|r"}, "Do as the Skumblade Do (35+)", nil, nil, nil, "A", nil, function()
return [[

N Required |N|You will need to be level 35 or higher to complete (aid:8108) achievement| |PL|35|
N Required |N|You will need to complete (guide:"Kirin Tor Offensive (Daily)") guide to access {Isle of Thunder}.| |AID|8099|
