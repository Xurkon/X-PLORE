...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Exploration|r ", "Lorewalkers (35+)", nil, "Horde", nil, "A", "|SG|UnitLevel([[player]])>=35 and DugisGuideViewer.SuggestReputationAchievementPredicate(1345)|", function()
return [[

N Please Read |N|This guide assumes that you are level 35 and completes the following achievements;<br/><b>(aid:6856)<br/><b>(aid:6846)<br/><b>(aid:6716)<br/><b>(aid:6857)<br/><b>(aid:6850)<br/><b>(aid:7230)<br/><b>(aid:6754)<br/><b>(aid:6855)<br/><b>(aid:6847)<br/><b>(aid:6858)<br/><b>(aid:7381). <br/><br/>You will also be awarded (aid:6548). <br/><br/>Tick this step.|
...
R Seat of Knowledge |QID|31096| |N|Travel to {Seat of Knowledge} (82.6, 29.3), on top of {Mogu'shan Palace}| |Z|390|

A Your Private Collection |N|(npc:61962) (83.2, 29.7)| |QID|31015| |NPC|61962| |Z|390|
...
N The Lorewalkers |N|You should now be Exalted with The Lorewalkers. The Quartermaster is located in the {Seat of Knowledge}. (npc:64605) (82.1, 29.3)| |NPC|64605| |Z|390|

R Shado-Pan Garrison |QID|32680| |N|Travel to {Shado-Pan Garrison} (50.77, 73.35)| |Z|388| 
...
end, {description = [[This guide assumes that you are level 35 and completes the following achievements;<br/><b>(aid:6856)<br/><b>(aid:6846)<br/><b>(aid:6716)<br/><b>(aid:6857)<br/><b>(aid:6850)<br/><b>(aid:7230)<br/><b>(aid:6754)<br/><b>(aid:6855)<br/><b>(aid:6847)<br/><b>(aid:6858)<br/><b>(aid:7381). <br/><br/>You will also be (aid:6548).]]})
	end
