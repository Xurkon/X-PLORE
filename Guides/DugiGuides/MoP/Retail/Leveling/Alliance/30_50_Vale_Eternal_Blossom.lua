...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Pandaria|r", "390(30-35 Entry)#390(30-35 Entry)#390(30-35 Entry)", nil, "Alliance", nil, "L", nil, function()
return [[

N Level 30 Required |N|You need to be at least Level 30 to complete the pre-quest that will allow you to enter Vale of Eternal Blossom| |PL|30|
