...
A Catch the Wild Wolpertinger! |QID|11431| |N|(npc:24657) (41.24, 18.52), due to EU law, this quest is not available for EU servers you can instead buy the quest reward for 50s from the brewfest vendor, Skip (x) this quest for EU {Durotar}| |NPC|24657| |Z|1|
A Pink Elekks On Parade |QID|11120| |N|(npc:24657) (41.24, 18.52) due to EU law, this quest is not available for EU servers, Skip (x) this quest for EU| |NPC|24657| |Z|1|
N (item:46735) |T| |N|Speak to (npc:24657) and collect (item:46735) (41.24, 18.49)| |L|46735| |Z|1| |NPC|24657| |QID|11431|
...
U (item:46735) |U|46735| |N|Wear the (item:46735) (41.61, 17.92)| |QID|11431| |Z|1|
C Catch the Wild Wolpertinger! |QID|11431| |N|The "dwarf," Glodrak Huntsniper, has asked you to capture 5 Stunned Wolpertingers using the (item:32907) He mentioned that you must be intoxicated or wearing (item:46735) to see them. (43.80, 16.88)| |U|32907| |NPC|23487| |Z|1|
T Catch the Wild Wolpertinger! |QID|11431| |N|(npc:24657), {Durotar}, (41.24, 18.51)| |NPC|24657| |Z|1|
...
R Orgrimmar |N|Travel to {Orgrimmar} (53.60, 78.78)| |Z|85| |QID|11120|
h Orgrimmar |N|Set hearth at {Orgrimmar} (npc:6929) (53.60, 78.78)| |NPC|6929| |Z|85| |QID|11120|

R Thunder Bluff |N|Travel to {Thunder Bluff}, use the Zeppelin from {Orgrimmar} (42.88, 65.25)| |WR| |Z|85| |QID|11120|
U (item:46735) |U|46735| |N|Wear the (item:46735) {Thunder Bluff} (30.02, 63.77)| |QID|11120| |Z|88|
K 3 (npc:23529) |QID|11120.2| |N|Use (item:32960) to kill 3 (npc:23529), you will need to wear (item:46735) to see them, (27.25, 55.88)| |U|32960| |Z|88| |NPC|23529|

R Orgrimmar |N|Travel to {Orgrimmar}, use the Zeppelin from {Thunder Bluff} (15.22, 25.85)| |Z|88| |WR| |QID|11120|

R Tirisfal Glades |N|Travel to {Tirisfal Glades}, use the Zeppelin from {Orgrimmar} (50.83, 55.83)| |Z|85| |WR| |QID|11120|
K 3 (npc:23530) |QID|11120.3| |N|Use (item:32960) to kill 3 (npc:23530), you will need to wear (item:46735) to see them, {Ruins of Lordaeron} (61.37, 11.41)| |U|32960| |Z|90| |NPC|23530|

R Silvermoon City |N|Travel to {Silvermoon City} by using the teleporter, {Ruins of Lordaeron} (54.91, 11.32)| |Z|90| |QID|11120|
K 3 (npc:23531) |QID|11120.1| |N|Use (item:32960) to kill 3 (npc:23531), you will need to wear (item:46735) to see them, {Eversong Woods} (56.31, 52.64)| |U|32960| |Z|94| NPC|23531|

R Orgrimmar |N|Travel to {Orgrimmar} (53.60, 78.78)| |Z|85| |QID|12421|
T Pink Elekks On Parade |QID|11120| |N|(npc:24657), {Durotar}, (41.24, 18.51)| |NPC|24657| |Z|1|
