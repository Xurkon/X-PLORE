...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Leatherworking 1-600", nil, "Horde", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Leatherworking]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
N Materials List 350-425 |N|<b>360 (item:33568)<br/><b>25 (item:38426)| |P|Leatherworking 425|
