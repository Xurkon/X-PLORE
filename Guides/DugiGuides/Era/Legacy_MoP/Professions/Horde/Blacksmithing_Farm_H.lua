...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling With Farming|r", "Blacksmithing w/Farming 1-600", nil, "Horde", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Blacksmithing]], nil, 600, [[Mining]])|", function()
return [[
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|85| |PM|Blacksmithing 75| 
N Train Apprentice Blacksmithing |N|(npc:3355) (76.4, 34.6), in {Orgrimmar}| |Z|85| |PM|Blacksmithing 75| |NPC|3355|
B (item:5956) |N|(npc:3356) (75.8, 35.2), in {Orgrimmar}| |L|5956| |Z|85| |P|Blacksmithing 51| |NPC|3356|

R Durotar |N|Travel to {Durotar} (45,14)| |P|Blacksmithing 75| |Z|1|
N Farm Durotar |MI| |LOOP| |N|Farm 120 (item:2835)<br/><b>373 (item:2770) (38.9, 15.5)(37.6, 20.9)(36.0, 34.1)(36.7, 51.7)(44.2, 49.6)(50.6, 47.2)(50.5, 63.1)(55.2, 66.9)(56.0, 49.1)(54.9, 37.1)(53.1, 29.1)(54.6, 18.8)(49.9, 17.7)(43.7, 24.0)| |L|2835 120| |Z|1| |P|Blacksmithing 75| |OBJ|310|
N Farm Durotar |MI| |LOOP| |N|Farm 120 (item:2835)<br/><b>373 (item:2770) (38.9, 15.5)(37.6, 20.9)(36.0, 34.1)(36.7, 51.7)(44.2, 49.6)(50.6, 47.2)(50.5, 63.1)(55.2, 66.9)(56.0, 49.1)(54.9, 37.1)(53.1, 29.1)(54.6, 18.8)(49.9, 17.7)(43.7, 24.0)| |L|2770 373| |Z|1| |P|Blacksmithing 75| |OBJ|310|

R Orgrimmar |N|Travel to {Orgrimmar} (45, 06)| |Z|85| |P|Blacksmithing 75|
N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:2770) into bars. Tick this step.| |Z|85| |P|Blacksmithing 100|
N Train New Recipes.. |N|as needed from (npc:3355) (76.4, 34.6), in {Orgrimmar}. Tick this step.| |Z|85| |P|Blacksmithing 75| |NPC|3355|
...
N Train Journeyman Blacksmithing |N|(npc:3355) (76.4, 34.6), in {Orgrimmar}| |Z|85| |PM|Blacksmithing 150| |NPC|3355|

R Northern Stranglethorn |N|Travel to {Northern Stranglethorn} (32.9, 48.5)| |Z|50| |P|Blacksmithing 125|
...
R Orgrimmar |N|Travel to {Orgrimmar} (45, 06)| |Z|85| |PM|Blacksmithing 375|
...
N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:7911) into bars. Tick this step.| |Z|85| |P|Blacksmithing 235|
N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:3858) into bars. Tick this step.| |Z|85| |P|Blacksmithing 250|
N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:10620) into bars. Tick this step.| |Z|85| |P|Blacksmithing 300|

N Train New Recipes.. |N|as needed from (npc:3355) (76.4, 34.6), in {Orgrimmar}. Tick this step.| |Z|85| |P|Blacksmithing 300| |NPC|3355|
...
N Train Master Blacksmithing |N|(npc:3355) (76.4, 34.6), in {Orgrimmar}| |Z|85| |PM|Blacksmithing 375| |NPC|3355|

R Hellfire Peninsula |N|Travel to {Hellfire Peninsula} (70.3, 49.7)| |Z|100| |P|Blacksmithing 350|
...
N Smelt Ore |SM| |N|Go to a forge (53.2, 28.2) and smelt all the (item:23424) into bars. Tick this step.| |Z|100| |P|Blacksmithing 335|

N Train New Recipes.. |N|as needed from (npc:16583) (53.2, 28.2), in {Thrallmar}| |Z|100| |P|Blacksmithing 325| |NPC|16583|
...
R Orgrimmar |N|Travel to {Orgrimmar} (53.7, 78.8)| |Z|85| |P|Blacksmithing 425|

N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:36909) into bars. Tick this step.| |Z|85| |P|Blacksmithing 405|
N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:36912) into bars. Tick this step.| |Z|85| |P|Blacksmithing 425|

N Train New Recipes.. |N|as needed from (npc:3355) (76.4, 34.6), in {Orgrimmar}| |Z|85| |P|Blacksmithing 425| |NPC|3355|
...
N Train Illustrious Grand Master Blacksmithing |N|(npc:3355) (76.4, 34.6), in {Orgrimmar}| |Z|85| |PM|Blacksmithing 525| |NPC|3355|
...
R Orgrimmar |N|Travel to {Orgrimmar} (53.7, 78.8)| |Z|85| |P|Blacksmithing 425|
N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:53038) into bars. Tick this step.| |Z|85| |P|Blacksmithing 500|

N Train New Recipes.. |N|as needed from (npc:3355) (76.4, 34.6), in {Orgrimmar}| |Z|85| |P|Blacksmithing 475| |NPC|3355|
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|85| |P|Blacksmithing 525|

N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the (item:52185) into bars. Tick this step.| |Z|85| |P|Blacksmithing 512|

N Train New Recipes.. |N|as needed from (npc:3355) (76.4, 34.6), in {Orgrimmar}| |Z|85| |P|Blacksmithing 512| |NPC|3355|
...
N Farm The Jade Forest |MI| |LOOP| |N|Farm 330 (item:72092) (27.8, 54.7)(36.3, 58.6)(37.9, 72.2)(45.0, 93.9)(53.6, 85.4)(67.4, 83.8)(62.9, 73.9)(54.6, 64.4)(48.0, 60.5)(51.2, 48.7)(52.7, 42.1)(67.8, 33.2)(67.7, 26.2)(61.9, 28.1)(46.3, 27.3)(47.2, 15.1)(36.0, 11.4)(25.7, 26.6)| |L|72092 330| |Z|371| |Z|Blacksmithing|575| |OBJ|209311, 209328|

R Greenstone Village |N|Travel to {Greenstone Village} (48.4, 36.8)| |Z|371| |P|Blacksmithing 575|
N Smelt Ore |SM| |N|Go to forge (48.4, 36.8) and smelt all the (item:72092) into (item:72096)<br/><br/>Tick this step.| |Z|371| |P|Blacksmithing 575|
