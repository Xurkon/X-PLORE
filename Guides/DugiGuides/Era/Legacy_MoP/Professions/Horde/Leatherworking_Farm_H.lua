...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling With Farming|r", "Leatherworking w/Farming 1-600", nil, "Horde", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Leatherworking]], nil, 600, [[Skinning]])|", function()
return [[
...
B 25 (item:38426) |N|(npc:3366) (60.3, 54.2)| |L|38426 25| |Z|85| |P|Leatherworking 425| |NPC|3366|
