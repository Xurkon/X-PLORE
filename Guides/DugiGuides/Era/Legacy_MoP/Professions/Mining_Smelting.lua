...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Mining by Smelting 1-375", nil, "Horde", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Mining]], nil, 375) and UnitLevel([[player]])>=80|", function()
return [[
...
N 400-525 |N|Smelting for leveling is very hit or miss, and requires a lot of rare ore to accomplish<br/><br/>Switch to the Mining guide and mine for the remainder levels. Guide Complete|
