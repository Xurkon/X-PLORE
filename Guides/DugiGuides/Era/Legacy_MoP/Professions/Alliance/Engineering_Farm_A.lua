...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling With Farming|r", "Engineering w/Farming 1-600", nil, "Alliance", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Engineering]], nil, 600, [[Mining]])|", function()
return [[
...
B (item:5956) |N|(npc:5519) {Engineering Supplies} (63.4, 31.4)| |Z|84| |L|5956| |P|Engineering 31| |NPC|5519|
B 2 (item:4399) |N|(npc:5519) {Engineering Supplies} (63.2, 31.8)| |L|4399 2| |Z|84| |P|Engineering 75| |NPC|5519|
N Save.. |N|You will need 6 (item:818)<br/><b>so SAVE all that you mine. Tick this step.| |P|Engineering 130|

R Elwynn Forest |N|Travel to {Elwynn Forest} (34.3, 52.6)| |P|Engineering 75| |Z|37|
N Farm Elwynn Forest |MI| |LOOP| |N|Farm 20 (item:2835)<br/><b>160 (item:2770) (30.8, 56.5)(28.6, 63.1)(26.9, 69.5)(20.9, 72.8)(23.7, 83.4)(37.4, 71.4)(39.3, 81.7)(49.6, 85.6)(60.4, 76.6)(69.1, 69.3)(74.0, 50.2)(81.8, 55.7)(79.4, 38.8)(65.2, 38.0)(62.1, 53.0)(50.0, 60.7)(43.5, 49.3)(38.6, 51.4)| |L|2835 20| |Z|37| |P|Engineering 75| |OBJ|310|
N Farm Elwynn Forest |MI| |LOOP| |N|Farm 20 (item:2835)<br/><b>160 (item:2770) (30.8, 56.5)(28.6, 63.1)(26.9, 69.5)(20.9, 72.8)(23.7, 83.4)(37.4, 71.4)(39.3, 81.7)(49.6, 85.6)(60.4, 76.6)(69.1, 69.3)(74.0, 50.2)(81.8, 55.7)(79.4, 38.8)(65.2, 38.0)(62.1, 53.0)(50.0, 60.7)(43.5, 49.3)(38.6, 51.4)| |L|2770 160| |Z|37| |P|Engineering 75| |OBJ|310|
N Farm (item:2589) |ENG| |N|Kill (npc:94) mobs (38.0, 58.6)(43.8, 55.2) for 30 (item:2589)| |L|2589 30| |Z|37| |P|Engineering 95| |NPC|94|

R Stormwind City |N|Travel to {Stormwind City} (63, 71)| |Z|84| |P|Engineering 51|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2770) into bars. Tick this step.| |Z|84| |P|Engineering 100|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|84| |P|Engineering 75| |NPC|5518|
...
R Northern Stranglethorn |N|Travel to {Northern Stranglethorn} (50.9, 17.0)| |Z|50| |P|Engineering 125|
...
R Stormwind City |N|Travel to {Stormwind City} (63, 71)| |Z|84| |P|Engineering 200|

B 4x(item:3857) |N|(npc:5512) {Blacksmithing Supplies} (63.2, 37.6)| |L|3857 4| |Z|84| |P|Engineering 176| |NPC|5512|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2771) into bars. Tick this step.| |Z|84| |P|Engineering 160|
N Create 138 (item:2841) |ENG| |N|<b>69 (item:2840)<br/><b>69 (item:3576)<br/><b>Use the forge (63.7, 37.0)| |L|2841 138| |Z|84| |P|Engineering 150|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2772) into bars. Tick this step.| |Z|84| |P|Engineering 176|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2776) into bars. Tick this step.| |Z|84| |P|Engineering 175|
N Smelt (item:3859) |SM| |N|Go to a forge (63.7, 37.0) and smelt (item:3859). Tick this step.| |L|3859 4| |Z|84| |P|Engineering 176|
...
N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|84| |P|Engineering 200| |NPC|5518|
...
R Gadgetzan |N|Travel to {Gadgetzan} (50.7, 28.5), in {Tanaris}| |Z|71| |P|Engineering 210|
B (item:18650) |N|(npc:8131) (50.7, 28.5)| |L|18650| |Z|71| |P|Engineering 210| |NPC|8131|

R Felwood |N|Travel to {Felwood} (51.2, 80.9)| |Z|77| |P|Engineering 250|
...
N Farm 50 (item:4338) |ENG| |N|Kill {Jaedenar} (39, 57), Jadefire (38, 67), and/or Deadwood (49, 86) Mobs for 50 (item:4338)| |L|4338 50| |Z|77| |P|Engineering 250|
...
R Stormwind City |N|Travel to {Stormwind City} (55.6, 85.9)| |Z|84| |P|Engineering 300|

N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:3858) into bars. Tick this step.| |Z|84| |P|Engineering 250|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:10620) into bars. Tick this step.| |Z|84| |P|Engineering 300|
...
N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|84| |P|Engineering 300| |NPC|5518|
...
R Hellfire Peninsula |N|Travel to {Hellfire Peninsula} (70.3, 49.7)| |Z|100| |P|Engineering 350|
...
N Smelt Ore |SM| |N|Go to a forge (56.8, 63.8) and smelt all the (item:23424) into bars. Tick this step.| |Z|100| |P|Engineering 350|

N Train New Recipes.. |N|as needed from (npc:18775) (55.7, 65.5), in {Honor Hold}. Tick this step.| |Z|100| |P|Engineering 350| |NPC|18775|
...
R Stormwind City |N|Travel to {Stormwind City} (55.6, 85.9)| |Z|84| |P|Engineering 350|

N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:23425) into bars. Tick this step.| |Z|84| |P|Engineering 350|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|84| |P|Engineering 350| |NPC|5518|
...
R Zul'Drak |N|Travel to {Zul'Drak} (12.6, 68.3)| |Z|121| |P|Engineering 425|

N Farm Zul'Drak |MI| |LOOP| |N|Farm 320 (item:36909)<br/><b>10 (item:37701)<br/><b>keep all (item:37705) (12.6, 68.3)(09.5, 75.9)(12.5, 85.8)(21.7, 70.4)(34.1, 66.0)(43.6, 83.1)(58.9, 76.5)(48.5, 66.9)(59.8, 58.4)(72.6, 47.3)(71.7, 31.4)(54.2, 47.3)(53.4, 32.6)(40.2, 40.5)(33.2, 40.9)(33.8, 61.1)| |L|37701 10| |Z|121| |P|Engineering 425| |OBJ|7881|
N Farm Zul'Drak |MI| |LOOP| |N|Farm 320 (item:36909)<br/><b>10 (item:37701)<br/><b>keep all (item:37705) (12.6, 68.3)(09.5, 75.9)(12.5, 85.8)(21.7, 70.4)(34.1, 66.0)(43.6, 83.1)(58.9, 76.5)(48.5, 66.9)(59.8, 58.4)(72.6, 47.3)(71.7, 31.4)(54.2, 47.3)(53.4, 32.6)(40.2, 40.5)(33.2, 40.9)(33.8, 61.1)| |L|36909 320| |Z|121| |P|Engineering 425| |OBJ|7881|
...
R Stormwind City |N|Travel to {Stormwind City} (55.6, 85.9)| |Z|84| |P|Engineering 425|

N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:36909) into bars. Tick this step.| |Z|84| |P|Engineering 425|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:36912) into bars. Tick this step.| |Z|84| |P|Engineering 425|
B 10 (item:33470) |N|Buy 10 (item:33470) from Auction House or Trade chat.| |L|33470 10| |P|Engineering 425|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|84| |P|Engineering 425| |NPC|5518|
...
R Stormwind City |N|Travel to {Stormwind City} (55.6, 85.9)| |Z|84| |P|Engineering 450|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Obsidian Ore] into bars. Tick this step.| |Z|84| |P|Engineering 500|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|84| |P|Engineering 450| |NPC|5518|
...
R Stormwind City |N|Travel to {Stormwind City} (63.7, 37.0)| |Z|84| |P|Engineering 500|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:52185) into bars. Tick this step.| |Z|84| |P|Engineering 500|
N (item:53039) |SM| |N|Go to a forge (63.7, 37.0) and create 5 (item:53039). Tick this step.| |Z|85| |P|Engineering 500|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|84| |P|Engineering 500| |NPC|5518|
...
N Farm The Jade Forest |MI| |LOOP| |N|Farm 250 (item:72092) (27.8, 54.7)(36.3, 58.6)(37.9, 72.2)(45.0, 93.9)(53.6, 85.4)(67.4, 83.8)(62.9, 73.9)(54.6, 64.4)(48.0, 60.5)(51.2, 48.7)(52.7, 42.1)(67.8, 33.2)(67.7, 26.2)(61.9, 28.1)(46.3, 27.3)(47.2, 15.1)(36.0, 11.4)(25.7, 26.6)| |L|72092 250| |Z|371| |Z|Engineering|575| |OBJ|209311, 209328|

R Valley of the Four Winds |N|Travel to {Valley of the Four Winds} (16.0, 83.0)| |Z|376| |P|Enginnering 600|
