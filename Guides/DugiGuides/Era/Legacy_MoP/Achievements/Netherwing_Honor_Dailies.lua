local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Netherwing_Honor_Dailies")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "Netherwing (Neutral-Honored Daily)", "Netherwing (Revered-Exalted Daily)", "Horde", nil, "D", nil, function()
return [[

N Pre-quest Required |N|You need to complete the (guide:"Netherwing (Pre-Quest)") guide first before you can begin this guide| |QID|10870|
...
C Crazed and Confused |N|Kill the (npc:23305) and 5 (npc:23324)| |QID|11083| |Z|104| |NPC|23305, 23324| |REP|1015, 5|
...
N 10 (item:21887) |QID|11054.1| |N|You can get the 10 Knothide Leather from the Auction House, or by Skinning mobs for the leather, If you want to get the 10 Knothide Leather by skinning, kill the mobs around the waypoint (60.4, 45.2)| |T| |Z|104| |REP|1015, 5|
...
T Hail, Commander! |N|Overlord Mor'ghor (66.2, 85.7), Revered| |QID|11092| |Z|104| |NPC|23140| |REP|1015, 7|
...
A Kill Them All! |N|Overlord Mor'ghor (66.2, 85.7) Scryers| |QID|11094| |Z|104| |NPC|23140| |REP|934, 5|
A Kill Them All! |N|Overlord Mor'ghor (66.2, 85.7) Aldor| |QID|11099| |Z|104| |NPC|23140| |REP|932, 5|
...
K 10 (npc:23269) |QID|11041.1| |N|Kill 10 (npc:23269) (70.2, 84.3)| |Z|104| |NPC|23269|
T A Job Unfinished... |QID|11041| |N|Overlord Mor'ghor (66.2, 85.7)| |QID|11041| |Z|104| |NPC|23140|
