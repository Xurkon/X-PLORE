local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Sha'tari_Skyguard_A")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "Sha'tari Skyguard (Reputation)", nil, "Alliance", nil, "D", nil, function()
return [[
