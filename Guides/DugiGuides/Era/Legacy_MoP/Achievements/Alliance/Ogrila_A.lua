local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Alliance_En_Ogrila_A")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "Ogri'la Reputation (Pre-Quest)", nil, "Alliance", nil, "D", nil, function() 
return [[
