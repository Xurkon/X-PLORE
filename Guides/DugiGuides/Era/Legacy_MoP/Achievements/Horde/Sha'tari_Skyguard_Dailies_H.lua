local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Sha'tari_Skyguard_Dailies_H")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "Sha'tari Skyguard / Ogri'la (Daily)", nil, "Horde", nil, "D", nil, function()
return [[
