local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Horde_En_Ogrila_H")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "Ogri'la (Pre-Quest)", nil, "Horde", nil, "D", nil, function() 
return [[
