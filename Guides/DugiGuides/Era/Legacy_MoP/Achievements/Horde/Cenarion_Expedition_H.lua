...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "Cenarion Expedition Reputation (70+)", nil, "Horde", nil, "A", nil, function()
return [[
...
R The Steamvault |N|Use your dungeon finder to queue for Steamvault or enter from {Coilfang Reservoir} in {Zangarmarsh}. You need to swim down and through the Resrvoir to reach the entrance(17.80, 27.40)| |I| |QID|29613| |WR| |Z|263| |NOWP|
