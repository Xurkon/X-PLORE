local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Sha'tari_Skyguard_H")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "Sha'tari Skyguard (Reputation)", nil, "Horde", nil, "D", nil, function()
return [[
