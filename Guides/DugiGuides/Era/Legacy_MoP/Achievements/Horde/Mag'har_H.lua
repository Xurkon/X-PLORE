...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Burning Crusade Reputation", "The Mag'har Reputation (70+)", nil, "Horde", nil, "A", nil, function()
return [[
...
K Exarch Maladaar |N|Slay (npc:18373) to free the spirit of D'ore. He can be found in {Auchenai Crypts} (74, 51)| |Z|257| |NOWP| |QID|10167| |NPC|18373|
