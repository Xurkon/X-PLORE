...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Azeroth 1-60|r", "242(47-52 Detention Block)", "687(50-54)", "Horde", nil, "I", nil, function()
return [[

R Blackrock Depths Detention Block |N|Queue/Zone into {Blackrock Depths} {Detention Block} in {Searing Gorge} (36, 77.4)| |Z|32| |I| |QID|27581| |F|242| |WR|
