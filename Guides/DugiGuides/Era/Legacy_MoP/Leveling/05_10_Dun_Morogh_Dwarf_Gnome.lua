...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r", "27(5-10 Dwarf & Gnome)", "48(10-20)", "Alliance", nil, "L", nil, function()
return [[
...
N Guide Complete |N|Tick to continue to (guide:"48(10-20)")|
