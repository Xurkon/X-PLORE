...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Eastern Kingdoms|r", "32(48-50)", "36(50-52)", "Horde", nil, "L", nil, function()
return [[

R New Kargath |N|Travel to {Badlands}, {New Kargath} (18.44, 41.47)| |QID|28512| |Z|104|
N Abandon (qid:28581) |N|Abandon (qid:28581) to accept (qid:28512)| |O| |QID|28581|
A To the Aid of the Thorium Brotherhood |QID|28512| |N|(npc:46660) (18.44, 41.47) {New Kargath}| |Z|104| |NPC|46660|
...
N Guide Complete |N|Tick to continue to (guide:"36(50-52)")|
