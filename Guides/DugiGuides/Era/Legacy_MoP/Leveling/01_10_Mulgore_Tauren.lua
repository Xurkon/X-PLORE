...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r", "7(1-10 Tauren)", "10(10-20)", "Horde", nil, "L", nil, function()
return [[
...
A Simple Note |QID|3091| |N|Rohaku Stonehoof (46.18, 82.38) {Red Cloud Mesa}| |R|Tauren| |C|Warrior| |NPC|44927|
T Simple Note |QID|3091| |N|Harutt Thunderhorn (45.04, 75.47)  {Camp Narache}| |R|Tauren| |C|Warrior| |NPC|3059|
A The First Lesson |QID|27020| |N|Harutt Thunderhorn (45.04, 75.47)  {Camp Narache}| |C|Warrior| |NPC|3059|
N Learn Spell: Charge |QID|27020.2| |N|Learn the spell Charge from Harutt Thunderhorn, Camp Narache (45.04, 75.47)| |C|Warrior|
C The First Lesson |QID|27020| |N|Practice using Charge on a training dummy, Camp Narache (45.35, 75.62)| |C|Warrior| |NPC|44848|
T The First Lesson |QID|27020| |N|Harutt Thunderhorn (45.04, 75.47)  {Camp Narache}| |C|Warrior| |NPC|3059|
 
A Consecrated Note |QID|27015| |N|Rohaku Stonehoof (46.18, 82.38) {Red Cloud Mesa}| |C|Paladin| |NPC|44927|
T Consecrated Note |QID|27015| |N|Sunwalker Helaku (44.97, 75.34)  {Camp Narache}| |C|Paladin| |NPC|37737|
A The Way of the Sunwalkers |QID|27023| |N|Sunwalker Helaku (44.97, 75.34)  {Camp Narache}| |C|Paladin| |NPC|37737|
N Learn Spell: Judgement|QID|27023.1| |N|Camp Narache (44.97, 75.34)| |C|Paladin|
N Learn Spell: Seal of Righteousness |QID|27023.3| |N|Camp Narache (44.98, 75.34)| |C|Paladin|
C The Way of the Sunwalkers |QID|27023| |N|Cast Seal of Righteousness then cast Judgement on a target dummy 45.63, 75.57)| |C|Paladin| |NPC|44848|
T The Way of the Sunwalkers |QID|27023| |N|Sunwalker Helaku (44.97, 75.34)  {Camp Narache}| |C|Paladin| |NPC|37737|

A Etched Note |QID|3092| |N|Rohaku Stonehoof (46.18, 82.38) {Red Cloud Mesa}| |C|Hunter| |NPC|44927|
T Etched Note |QID|3092| |N|Lanka Farshot (45.28, 75.31)  {Camp Narache}| |C|Hunter| |NPC|3061|
A The Hunter's Path |QID|27021| |N|Lanka Farshot (45.28, 75.31)  {Camp Narache}| |C|Hunter| |NPC|3061|
N Learn Spell: Steady Shot |QID|27021.2| |N|Camp Narache (45.27, 75.32)| |C|Hunter|
C The Hunter's Path |QID|27021| |N|Cast Steady Shot 5x on a target dummy (45.36, 75.55)| |C|Hunter| |NPC|44848|
T The Hunter's Path |QID|27021| |N|Lanka Farshot (45.28, 75.31)  {Camp Narache}| |C|Hunter| |NPC|3061|

A Rune-Inscribed Note |QID|3093| |N|Rohaku Stonehoof (46.18, 82.38) {Red Cloud Mesa}| |C|Shaman| |NPC|44927|
T Rune-Inscribed Note |QID|3093| |N|Meela Dawnstrider (45.09, 75.07)  {Camp Narache}| |C|Shaman| |NPC|3062|
A Primal Strike |QID|27027| |N|Meela Dawnstrider (45.09, 75.07)  {Camp Narache}| |C|Shaman| |NPC|3062|
N Learn Spell: Primal Strike |QID|27027.2| |N|Camp Narache (45.09, 75.07)| |C|Shaman|
C Primal Strike |QID|27027| |N|Use Primal Strike 3x on a target dummy (45.41, 75.41)| |C|Shaman| |NPC|44848|
T Primal Strike |QID|27027| |N|Meela Dawnstrider (45.09, 75.07)  {Camp Narache}| |C|Shaman| |NPC|3062|

A Hallowed Note |QID|27014| |N|Rohaku Stonehoof (46.18, 82.38) {Red Cloud Mesa}| |C|Priest| |NPC|44927|
T Hallowed Note |QID|27014| |N|Seer Ravenfeather (45.00, 75.19)  {Camp Narache}| |C|Priest| |NPC|37724|
A Healing in a Flash |QID|27066| |N|Seer Ravenfeather (45.00, 75.19)  {Camp Narache}| |C|Priest| |NPC|37724|
N Learn Spell: Flash Heal |QID|27066.2| |N|Camp Narache (45.00, 75.19)| |C|Priest|
C Healing in a Flash |QID|27066| |N|Cast Flash Heal on a Wounder Braves 5x (45.58, 75.36)| |C|Priest| |NPC|45199|
T Healing in a Flash |QID|27066| |N|Seer Ravenfeather (45.00, 75.19)  {Camp Narache}| |C|Priest| |NPC|37724|

A Verdant Note |QID|3094| |N|Rohaku Stonehoof (46.18, 82.38) {Red Cloud Mesa}| |C|Druid| |NPC|44927|
T Verdant Note |QID|3094| |N|Gart Mistrunner (45.22, 75.13)  {Camp Narache}| |C|Druid| |NPC|3060|
A The Healer's Touch |QID|27067| |N|Gart Mistrunner (45.22, 75.13)  {Camp Narache}| |C|Druid| |NPC|3060|
N Learn Spell: Rejuvenation |QID|27067.2| |N|Camp Narache (45.22, 75.13)| |C|Druid|
C The Healer's Touch |QID|27067| |N|Cast Rejuvenation on a Wounder Braves 5x (45.63, 75.34)| |C|Druid| |NPC|45199|
T The Healer's Touch |QID|27067| |N|Gart Mistrunner (45.22, 75.13)  {Camp Narache}| |C|Druid| |NPC|3060|
...
N Guide Complete |N|Tick to continue to (guide:"10(10-20)")| 
