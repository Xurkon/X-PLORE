local Guide = DugisGuideViewer:RegisterModule("DugisGuide_SpecQL_Alliance_En_Engineering_Goblin_Membership_Card_Renewal")
function Guide:Initialize()
    function Guide:Load()DugisGuideViewer:RegisterGuide({"|cffffd200Specialization Questlines|r", "|cffffd200Engineering|r"}, "Goblin Membership Card Renewal", nil, "Alliance", nil, "P", nil, function()
return [[
...
T Membership Card Renewal |QID|3644| |N|(npc:8126) in (map:1446) (52.48,27.33)| |Z|1446| |NPC|8126| |D|
