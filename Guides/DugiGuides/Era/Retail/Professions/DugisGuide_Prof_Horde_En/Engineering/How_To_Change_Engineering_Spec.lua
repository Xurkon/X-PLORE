local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Horde_En_Engineering_How_To_Change_Engineering_Spec")
function Guide:Initialize()
    function Guide:Load()DugisGuideViewer:RegisterGuide({"|cffffd200Specialization Questlines|r", "|cffffd200Engineering|r"}, "How To Change Engineering Speialization", nil, "Horde", nil, "P", nil, function()
return [[
...
N Unlearn Engineering |N|Unlearn Engineering<br/><b>Press "K" to open your Skills tab.<br/><b>You must completely unlearn the Engineering profession to be able to switch your specialization.<br/>Tick this step.|
...
N Level 200 |N|Reach level 200 Engineering<br/><b>You must be at least level 200 Engineering to be able to start the questlines to choose an Engineering specialization.| |P|202 200|
