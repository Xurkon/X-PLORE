local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Horde_En_Blacksmithing_Master_Hammersmith")
function Guide:Initialize()
    function Guide:Load()DugisGuideViewer:RegisterGuide({"|cffffd200Specialization Quests|r", "|cffffd200Blacksmithing|r"}, "Master Hammersmith", nil, "Horde", nil, "P", nil, function()
return [[
...
K (npc:11120) |QID|5305.1| |N|Kill (npc:11120)<br/><b>He is a boss inside the Main Gate section of the Stratholme dungeon.<br/><b>Use the (guide:"Scholomance / Stratholme (55-58)") dungeon guide to accomplish this.| |I| |NPC|11120| |L|13351|
T Sweet Serenity |QID|5305| |N|(npc:11191) in (map:1452) (61.33,37.13)| |Z|1452| |NPC|11191|
N Learn (spell:17040) |N|Speak to (npc:11191) inside the building Tell him "Please teach me how to become a hammersmith, Lilith." (61.33,37.13)| |Z|1452| |NPC|11191|
...
N Learn (spell:16973) |N|Use (item:12824) to learn (spell:16973)| |U|12824|

N Guide Complete

]]
end, {description = [[This guide will walk you through completing the Hammersmith questline to continue Weaponsmith specialization for the Blacksmithing profession.]]})
    end
