...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Classic Reputation|r ", "Bloodsail Bucaneers (35+)", nil, "Horde", nil, "A", nil, function()
return [[

N Low Level Quests |N|if you are over level 35, make sure you are tracking low level quests to make it easier to see the quests givers. Tick this step.|
