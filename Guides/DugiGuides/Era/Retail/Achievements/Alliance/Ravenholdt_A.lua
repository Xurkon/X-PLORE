...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Classic Reputation|r ", "Ravenholdt (30+)", nil, "Alliance", nil, "A", nil, function()
return [[
...
end, {description = [[This guide covers how to gain reputation with (fac:349)]]})
	end
