...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Classic Reputation|r ", "Bloodsail Bucaneers (35+)", nil, "Aliiance", "A", nil, function()
return [[

N Please Read! |N|Gaining Reputation with the Bloodsail Bucaneers is required for the (aid:2336). Tick this step.|
...
A Looks Like a Tauren Pirate to Me |QID|26630| |N|(npc:2487) (41.08, 73.24) in {Booty Bay}| |NPC|2487| |Z|210|
N (item:59147) |QID|26630.3| |N|Collect a (item:59147) from (npc:43505) (found on the second floor), speak to (npc:43505) and tell her you're sorry that you have cut her head of. {Booty Bay} (43.30, 71.70)| |T| |NPC|43505| |Z|210|
B (item:59148) |QID|26630.2| |N|Buy an (item:59148) from (npc:2663). {The Old Port Authority} (42.65, 69.11)| |NPC|2663| |Z|210|
C Looks Like a Tauren Pirate to Me |QID|26630| |N|Bring both items to (npc:2487) in {Booty Bay} (41.10, 73.23)| |NPC|2487| |Z|210|
T Looks Like a Tauren Pirate to Me |QID|26630| |N|(npc:2487) (41.08, 73.24) in {Booty Bay}| |NPC|2487| |Z|210|
...
end, {description = [[Gaining Reputation with the (fac:87) is required for the (aid:2336).]]})
	end
