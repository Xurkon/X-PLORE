local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Leveling_Horde_En_47_47_StranglethornVale")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Azeroth 40-50|r", "1434(47-47)#1434(47-47)#1434(47-47)", "1427(47-48)#1427(47-48)#1427(47-48)", "Horde", nil, "L", nil, function()
return [[

R Grom'gol Base Camp |QID|2932| |N|Travel to {Grom'gol Base Camp} (32.16, 27.77)| |Z|1434| |O|
T Grim Message |QID|2932| |N|(npc:2497) in {Grom'gol Base Camp} (32.16, 27.77)| |Z|1434| |O| |NPC|2497|

R Nesingwary's Expedition |QID|196| |N|Travel to {Nesingwary's Expedition} (35.65, 10.79)| |O| 
T Raptor Mastery (3) |QID|196| |N|(npc:715) in {Nesingwary's Expedition} (35.65, 10.79)| |O| |NPC|715|
C Raptor Mastery (4) |QID|197| |N|Kill (npc:730) and loot (item:3877) (28, 44)| |PRE|196| |W| |NPC|730|

T Raptor Mastery (4) |QID|197| |N|(npc:715) in {Nesingwary's Expedition} (35.7, 10.8)| |PRE|196| |NPC|715|
A Big Game Hunter |QID|208| |N|(npc:715) in {Nesingwary's Expedition} (35.7, 10.8)| |PRE|196| |NPC|715|
C Big Game Hunter |QID|208| |N|Kill (npc:731) and loot the (item:3880) (38, 35)| |PRE|196| |NPC|731|
...
T Rescue OOX-22/FE! |QID|2767| |N|(npc:7406) in {Booty Bay} (28.20, 76.20)| |Z|1434| |O| |NPC|7406|
h Booty Bay |QID|610| |N|Speak to (npc:6807) {The Salty Sailor Tavern} (27.05, 77.32)| |Z|1434| |NPC|
...
A The Captain's Chest |QID|8551| |N|(npc:2500) in {Booty Bay} (26.70, 73.61)| |Z|1434| |NPC|2500|
...
R Wild Shore |QID|8551| |N|Travel to {Wild Shore} (33.77, 74.85)| |Z|1434|
N As you go... |AYG|614| |QID|594| |N|Look for a Half Burried Bottle (green) along the beach and check it for (item:4098) to start quest| |L|4098| |OBJ|228|
C The Captain's Chest |QID|8551| |N|Kill (npc:1492) and collect (item:3932) in {The Crystal Shore}<br/><br/>(npc:1492) is a level 47 Elite and you might need help to kill him otherwise it is safe to skip (33.77, 74.85) (39.19, 60.70) (36.95, 69.73)| |Z|1434| |NPC|1492|
...
N (item:4098) |N|You can now destroy (item:4098) if you still have it<br/><br/>Tick this step| |L|4098| |O|
...
T The Captain's Chest |QID|8551| |N|(npc:2500) in {Booty Bay} (26.69, 73.62)| |Z|1434| |NPC|2500|
N (item:6081) |QID|1383| |N|Withdraw (item:6081) from the bank<br/><br/>Tick this step (26.6, 76.4)| |Z|1434| |L|6081| |OO| |NPC|2625| --Booty bay
N (item:6080) |QID|1383| |N|Withdraw (item:6080) from the bank<br/><br/>Tick this step (26.6, 76.4)| |Z|1434| |L|6080| |OO| |NPC|2625| --Booty bay
N (item:6082) |QID|1383| |N|Withdraw (item:6082) from the bank<br/><br/>Tick this step (26.6, 76.4)| |Z|1434| |L|6082| |OO| |NPC|2625| --Booty bay
