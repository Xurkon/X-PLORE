...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r ", "27(1-30)#27(1-30)#27(1-30)", "48(5-30)#48(5-30)#48(5-30)", "Alliance", nil, "L", nil, function()
return [[
...
f Gol'Bolar Quarry |N|Grab the flight path for {Gol'Bolar Quarry} from (npc:43702) (75.85, 54.35)| |QID|25986| |NPC|43702|
...
N Guide Complete |N|Tick to continue to (guide:"48(5-30)#48(5-30)#48(5-30)")|
