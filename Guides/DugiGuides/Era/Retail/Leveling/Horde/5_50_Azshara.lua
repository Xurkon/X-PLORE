...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Kalimdor|r ", "76(5-30)#76(5-30)#76(5-30)", "63(7-30)#63(7-30)#63(7-30)", "Horde", nil, "L", nil, function()
return [[
...
N Survey North Marker |QID|14202.2| |N|Escort a Goblin Surveyor to the North Marker. Defend her while she takes readings. If it doesn't work, unsummon the Surveyor by right clicking (spell:67570) buff and you can summon another suveyor with your (item:48665) to start over (34.66, 71.58) {Lake Mennar}| |U|48665| |NPC|35485, 35484|
N Survey East Marker |QID|14202.3| |N|Escort the surveyor to the East Marker (37.46, 74.05) {Lake Mennar}| |NPC|35485, 35484|
N Survey West Marker |QID|14202.1| |N|Escort the surveyor to the West Marker (34.47, 76.59) {Lake Mennar}| |NPC|35485, 35484|
...
C Gunk in the Trunk |QID|14209| |N|Collect an (item:48780) from the (npc:35526) engine (30.03, 67.18) in {Orgrimmar Rocketway Exchange}| |NPC|35558, 35526|
...
N Speak to Kalytha |N|Speak to Kalytha and tick this step (36.38, 72.38)| |QID|14215| |NPC|35567| |POI| |BUFF|136223|
...
T Memories of the Dead |QID|14215| |N|Field turn in {Lake Mennar} (37.51, 74.51)|
A Mystery of the Sarcen Stone |QID|14216| |N|Auto quest (29.77, 66.97)| |Z|76| |NPC|35087|
C Mystery of the Sarcen Stone |QID|14216| |N|Click on Ancient Stone Cask to retrieve the Sarcen Stone from the bottom of {Lake Mennar} (35.61, 75.32)| |Z|76|
T Mystery of the Sarcen Stone |QID|14216| |N|(npc:35087) in {Orgrimmar Rocketway Exchange} (29.71, 66.84)| |Z|76| |NPC|35087|

R The Secret Lab |QID|14408| |N|Travel to {The Secret Lab}| |NPC|36500|
...
f Southern Rocketway Terminus |N|Grab {Southern Rocketway Terminus} flight path (51.48, 74.29)| |QID|14258| |NPC|37005| 
...
f Bilgewater Harbor |N|Grab {Bilgewater Harbor} flight path (52.92, 49.87)| |QID|14131| |NPC|8610| 
...
f Valormok |N|Grab {Valormok} flight path (14.35, 65.01)| |QID|14464| |NPC|36728| 
...
N Guide Complete |N|Tick to continue to (guide:"63(7-30)#63(7-30)#63(7-30)")|
