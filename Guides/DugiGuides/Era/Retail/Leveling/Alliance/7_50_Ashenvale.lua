...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Kalimdor|r ", "63(7-30)#63(7-30)#63(7-30)", "65(10-30)#65(10-30)#65(10-30)", "Alliance", nil, "L", nil, function()
return [[
...
f Blackfathom Camp |N|Grab the {Blackfathom Camp} Flight Path (18.20, 20.59)| |QID|13602| |NPC|34374| 
...
f Astranaar |N|Grab the {Astranaar} Flight Path (34.42, 48.06)| |QID|13849| |NPC|4267| 
...
f Forest Song |N|Grab the {Forest Song} Flight Path (85.04, 43.52)| |QID|26455| |NPC|22935| 
...
f Stardust Spire |N|Grab the {Stardust Spire} Flight Path (35.04, 72.05)| |QID|13989| |NPC|34378| 
...
N Guide Complete |N|Tick to continue to (guide:"65(10-30)#65(10-30)#65(10-30)")| 
]]
