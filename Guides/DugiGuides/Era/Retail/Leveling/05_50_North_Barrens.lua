...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Kalimdor|r ", "10(5-30)#10(5-30)#10(5-30)", "63(7-30)#63(7-30)#63(7-30)", "Horde", nil, "L", nil, function()
return [[
...
C Drag it Out of Them |QID|13961| |N|Use the (item:46722) to ensnare a (npc:34503) then talk to it to capture it. Then deliver the captured Razormane Pillager to (npc:34513) in {Grol'dom Farm} (56.55, 40.40)| |NPC|34513| |U|46722|
...
f The Crossroads |N|Grab the flight path for {The Crossroads} from (npc:3615) (48.70, 58.67)| |QID|848| |NPC|3615| 
...
f Ratchet |N|Grab the flight path for {Ratchet} from (npc:16227) (69.12, 70.70)| |QID|14034| |NPC|16227| 
...
f Nozzlepot's Outpost |N|Grab the flight path for {Nozzlepot's Outpost} from (npc:40558) (62.32, 17.11)| |QID|29087| |NPC|40558| 
