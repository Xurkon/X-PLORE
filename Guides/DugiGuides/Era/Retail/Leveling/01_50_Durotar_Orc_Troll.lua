...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r ", "1(1-30)#1(1-30)#1(1-30)", "10(1-30)#10(1-30)#10(1-30)", "Horde", nil, "L", nil, function()
return [[
...
f Razor Hill |TID|25171| |N|Talk to (npc:41142) to get flight path for {Sen'jin Village} (55.39, 73.33)| |QID|25173| |NPC|41142|
R Razor Hill |TID|25171| |N|Speak to (npc:10676) for a free ride to {Razor Hill} (55.2, 74.6)| |NPC|10676| |V|
...
F Orgrimmar |N|Speak to (npc:41140) and fly to Orgrimmmar (53.09, 43.59)| |QID|6385| |NPC|41140| |R|Orc, Tauren, Troll| |Z|85|
...
N Guide Complete |N|Tick to continue to (guide:"10(1-30)#10(1-30)#10(1-30)")| 
]]
