...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Eastern Kingdoms|r ", "21(5-30)#21(5-30)#21(5-30)", "25(7-30)#25(7-30)#25(7-30)", "Horde", nil, "L", nil, function()
return [[

R Brill |QID|26965| |N|Travel to {Brill} in {Tirisfal Glades} (60.4, 51.8)| |Z|18| |OID|26965|
N Abandon (qid:26964) |N|Abandon (qid:28568) so you can accept (qid:26964) from Executor Zygand| |QID|28568| |O|
A Warchief's Command: Silverpine Forest! |N|Executor Zygand (60.4, 51.8)| |QID|26964| |Z|18| |OID|26965|
f Brill |N|Grab the flight path for {Brill} from (npc:43124) (58.83, 51.92)| |QID|26965| |NPC|43124| |R|BloodElf, Orc, Tauren, Troll, Goblin| |Z|18| |OID|26965|

R Silverpine Forest |N|Travel to {Silverpine Forest} (57.45, 10.13)| |QID|26965| |OID|26965|
R Forsaken High Command |N|Travel to {Forsaken High Command} (57.45, 10.13)| |QID|26965| |OID|26965|
T Warchief's Command: Silverpine Forest! |N|(npc:44615) (57.45, 10.13) in {Forsaken High Command}| |NPC|44615| |QID|26964| |OID|26965|
...
C No Escape |QID|27099| |N|Find the Human leaders upstairs in {Fenris Keep}. After the cinematic, Agatha will fly you back to<br/><b>Note: Don't skip the cinematic or you won't get completion credit for the quest, you can walk out and walk in back into the room to restart the cinematic. (npc:44365) (65.84, 24.52)|
...
f The Sepulcher |N|Grab the flight path for {The Sepulcher} from (npc:2226) (45.41, 42.50)| |QID|27232| |NPC|2226| 
...
f Forsaken Forward Command |N|Grab the flight path for {Forsaken Forward Command} from (npc:45479) (57.28, 17.77)| |Z|217| |QID|27349| |NPC|45479|
...
N Guide Complete |N|Tick to continue to (guide:"25(7-30)#25(7-30)#25(7-30)")|
