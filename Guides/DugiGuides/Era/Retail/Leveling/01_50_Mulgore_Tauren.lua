...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r ", "7(1-10 Tauren)#7(1-10 Tauren)#7(1-10 Tauren)", "10(5-30)#10(5-30)#10(5-30)", "Horde", nil, "L", nil, function()
return [[
...
f Orgrimmar |N|Grab the flight path for {Orgrimmar} from (npc:3310) (49.63, 59.23)| |Z|85| |NPC|3310|
