local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Alliance_En_1_300_Cooking_Fishing")
function Guide:Initialize()
    function Guide:Load()DugisGuideViewer:RegisterGuide({"|cffffd200Classic Leveling|r"}, "Cooking + Fishing (1-300)", nil, "Alliance", nil, "P", nil, function()
return [[

N Reach Level 5 |N|You must be at least this level before you can progress| |PL|5|
B (item:6256) |N|Speak to (npc:66) and buy (item:6256) (41.82,67.16)| |Z|1429| |NPC|66| |L|6256| |P|356 75|
B 10 (item:6529) |N|Speak to (npc:66) and buy 10 (item:6529) (41.82,67.16)| |Z|1429| |NPC|66| |L|6529 10| |P|356 75|

N Learn Apprentice Fishing |N|Speak to (npc:1651) and learn (spell:7620) (47.61,62.32)| |Z|1429| |PM|356 75|

N 1-75 (map:1429) |FIS| |N|Fish in the Water (47.68,62.52)<br/><b>Use the "Fishing" skill in your spell book<br/><b>Equip the Fishing Pole in your bags<br/><b>Save the fish you catch, to cook later<br/><b>Use (item:6529) on your Fishing Pole<br/><b>Try to keep one of these active whenever you are fishing| |Z|1429| |U|6529| |P|356 75|

N Learn Journeyman Fishing |N|Speak to (npc:1651) and learn (spell:7731) (47.61,62.32)| |Z|1429| |NPC|1651| |PM|356 150|
N Learn Apprentice Cooking |N|Speak to (npc:1430) inside the building and learn (spell:2550) (44.37,65.99)| |Z|1429| |NPC|1430| |PM|185 75|

B (item:6325) |N|Speak to (npc:66) and buy (item:6325) (41.99,67.16)| |Z|1429| |NPC|66| |L|6325| |P|185 55|
B (item:6328) |N|Speak to (npc:66) and buy (item:6328) (41.99,67.16)<br/><b>Save this for later| |Z|1429| |NPC|66| |L|6328| |P|185 55|

N Learn (spell:7751) |N|Use (item:6325) to learn (spell:7751)| |U|6325| |P|185 55|

N 75-130 (map:1429) |FIS| |N|Fish in the Water (45.97,58.54)<br/><b>Use the "Fishing" skill in your spell book<br/><b>Equip the Fishing Pole in your bags<br/><b>Save the fish you catch, to cook later<br/><b>Use (item:6529) on your Fishing Pole<br/><b>Try to keep one of these active whenever you are fishing| |Z|1429| |U|6529| |P|356 130|
N 55 (item:6291) |N|Collect 55 (item:6291)| |L|6291 55| |P|356 130|
N 60 (item:6289) |N|Collect 60 (item:6289)| |L|6289 60| |P|356 130|

B (item:6330) |N|Speak to (npc:5494) and buy (item:6330) (45.77,58.58)<br/><b>Save this for later| |Z|1453| |NPC|5494| |L|6330| |P|185 55|
...
N Learn Journeyman Cooking |N|Speak to (npc:5482) inside the buidling (75.60,37.04)| |Z|1453| |NPC|5482| |P|185 100|
...
N Learn Expert Fishing |N|Use (item:16083) to learn (spell:7732)| |U|16083| |P|356 205|
...
B (item:4471) |N|Speak to (npc:3962) inside the building and buy (item:4471) (3485,50.87)<br/><b>You need to have (item:4471) in your bags to be able to create Basic Campfires to cook with| |Z|1440| |NPC|3962| |L|4471| |P|356 205|
B 10 (item:4470) |N|Speak to (npc:3962) inside the building and buy (item:4470) (3485,50.87)<br/><b>You will use one of these each time you create a Basic Campfire to cook with| |Z|1440| |NPC|3962| |L|4470 10| |P|356 205|
...
B 20 (item:6532) |N|Speak to (npc:7947) inside the building and buy 20 (item:6532) (31.30,43.46)| |Z|1444| |NPC|7947| |L|6532 20| |P|185 235|

N 225-300 (map:1444) |FIS| |N|Fish in the Water (62.39,52.49)<br/><b>Save any (item:13758) you catch<br/><b>Use (item:6532) on your Fishing Pole<br/><b>These will allow you to catch fish easier| |Z|1445| |U|6532| |P|356 300|
