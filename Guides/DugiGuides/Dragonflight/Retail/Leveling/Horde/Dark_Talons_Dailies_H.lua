local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dragonflight_Ach_Dark_Talons_Dailies_A")
function Guide:Initialize()
    function Guide:Load()DugisGuideViewer:RegisterGuide({"|cffffd200Dragonflight|r", "|cffffd200Reputation|r"}, "Dark Talons (Dailies)", nil, "Horde", nil, "D", "|SG|UnitLevel([[player]])>=70|", function()
return [[
