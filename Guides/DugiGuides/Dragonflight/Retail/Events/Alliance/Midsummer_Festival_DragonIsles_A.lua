local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Events_Alliance_En_Midsummer_Festival_DragonIsles_A")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Midsummer Festival|r ", "Midsummer Festival Dragon Isles (60+)", nil, "Alliance", nil, "E", "|SG|DugisGuideViewer.SuggestCurrentHolidayPredicate([[Calendar_Midsummer]])|", function()
return [[

N Prerequisite Required |TID|70125| |N|You must complete The Dragonscale Expedition (intro) first.<br/>(guide:"The Dragonscale Expedition (10)")|
