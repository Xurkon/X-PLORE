...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Karazhan Attunement (45-50)", nil, nil, nil, "L", nil, function()
return [[
...
K (npc:95675) |QID|45422.1| |N|Kill (npc:95675) in (guide:"703(10-45)") (51.44,88.83)| |Z|703| |NPC|95675|
...
N (item:142329) |QID|44887.3| |N|Kill (npc:96015) in (guide:"710(45-50)") and collect (item:142329)<br/><br/>This is the 2nd boss in the instance|
N (item:142330) |QID|44887.2| |N|Collect (item:142329) from any boss in (guide:"732(10-45)")|
N (item:142328) |QID|44887.1| |N|Kill (npc:98949) in (guide:"751(10-45)") and collect (item:142328)|
