...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "706(45-50)", nil, nil, nil, "I", nil, function()
return [[
...
N Switch Guide |QID|43586| |N|Switch to (guide:"Class Campaign (10-50)") guide| |O| |C|Warrior|
