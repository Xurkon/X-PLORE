...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "749(45-50 Heroic)", nil, nil, nil, "I", nil, function()
return [[

N Pre-Quest Required |N|Switch to (guide:"680(45+)#680(45+)#680(45+)") and complete the guide until you get the quest (qid:42490)| |OID|42490|
