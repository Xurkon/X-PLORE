local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Ach_Legion_Hidden_Potential_Shaman_Elemental")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide({"|cffffd200Legion|r", "|cffffd200Hidden Potential|r"}, "Elemental - Lost Codex of the Amani", nil, nil, "SHAMAN", "A", nil, function()
return [[
...
N Drops From Rares |N|(item:139572) Drops from rares in {Dalaran Sewers}| |Z|628| |L|139572|
U (item:139572) |N|Use (item:139572) to add the appearance to your artifact, congrats!| |U|139572| |AID|10460|
