...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "SHAMAN", "L", nil, function()
return [[
...
N Switch Guide |N|Switch guide to (guide:"1046(10-50)") and complete it to kill (npc:91789) and collect the (item:138995) for the quest (qid:42984)<br/><br/>Make sure you complete the entire dungeon and kill (npc:96028) to complete the quest| |QID|42984|
...
N (item:136792) |QID|41897.1| |N|Collect (item:136792) in {The Twilight Throne} (61.74,71.99)| |Z|207|
N (item:136793) |QID|41897.1| |N|Collect (item:136793) in {The Twilight Throne} (62.37,75.96)| |Z|207|
...
N Switch Guide |N|Switch to (guide:"731(10-45)") and kill (npc:91007) to collect (item:138999) for the quest (qid:42990)| |QID|42990|
C The Earthen Amulet |QID|42990| |N|Kill (npc:91007) in (guide:"731(10-50) and collect (item:138999)| |QID|42990|
