...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "905(45+)#905(45+)#905(45+)", nil, nil, nil, "D", "|SG|UnitLevel([[player]])==GetMaxPlayerLevel()|", function()
return [[

N Pre-quest Required |N|You need to unlock Broken Shore world quest first before you can move on to Argus<br/><br/>Use the (guide:"646(45+)#646(45+)#646(45+)") guide| |QID|46734|
