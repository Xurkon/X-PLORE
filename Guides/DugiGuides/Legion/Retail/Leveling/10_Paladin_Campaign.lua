...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "PALADIN", "L", nil, function()
return [[
...
N Switch Guide |QID|43487| |N|Switch to (guide:"732(10-45)") to kill (npc:102282) and collect (item:139445) for the quest (qid:43487)|
...
N Switch Guide |QID|43493| |N|Switch guide to (guide:"751(10-45)") and kill (npc:94923) for the quest (qid:43493)|
...
K (npc:119214) |QID|46259.1| |N|Kill (npc:119214) in {Val'sharah} (66.99,52.82) (68.59,54.89) (65.69,59.68)| |Z|641| |NPC|119214|
...
N Choose 2 allies to recruit |SID|0|1| |N|Choose 2 allies to recruit (63.59,79.00)| |Z|827| |QID|45770|
