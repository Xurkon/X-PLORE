...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "DRUID", "L", nil, function()
return [[
...
N Paradise Lost |TID|39718| |N|Switch to (guide:"630(10-50)#630(10-50)#630(10-50)") guide| |O|
N The Tranquil Forest |TID|39731| |N|Switch to (guide:"641(10-50)#641(10-50)#641(10-50)") guide| |O|
N The Lone Mountain |TID|39733| |N|Switch to (guide:"650(10-50)#650(10-50)#650(10-50)") guide| |O|
N Stormheim |TID|39735| |N|Switch to (guide:"634(10-50)#634(10-50)#634(10-50)") guide| |O|
N Stormheim |TID|44701| |N|Switch to (guide:"634(10-50)#634(10-50)#634(10-50)") guide| |O|
N Stormheim |TID|39864| |N|Switch to (guide:"634(10-50)#634(10-50)#634(10-50)") guide| |O|
N Stormheim |TID|44700| |N|Switch to (guide:"634(10-50)#634(10-50)#634(10-50)") guide| |O|
...
C A Glade Defense |QID|42586| |N|Use the Scouting Map and complete the mission, (mission:924). This is a 1 hour mission| |Z|747| |NPC|98002| |POI|
...
N Switch Guide |N|Complete the (guide:"733(10-45)") to kill (npc:103344) and collect (item:140313) and kill (npc:101403)| |QID|44076|
N Switch Guide |N|Complete the (guide:"731(10-45)") to kill (npc:91003) and collect (item:140311) and kill (npc:107704)| |QID|44074|
N Switch Guide |N|Complete the (guide:"713(10-45)") to kill (npc:96028) and collect (item:140312)| |QID|44077|
N Switch Guide |N|Complete the (guide:"703(10-45)") to kill (npc:99868) and collect (item:139469) and complete Odyn's Trial| |QID|44075|
...
N Level 45 Required |N|You need to be at least level 45 to continue with the class campaign quest line| |PL|45|
...
N Switch Guide |QID|40890| |N|Complete the (guide:"641(10-50)#641(10-50)#641(10-50)") until you complete the quest (qid:40890)|
...
K (npc:106222) |QID|42044.1| |N|Kill (npc:106222) in {Emerald Dreamway} (63.73,40.81)| |Z|715| |NPC|106222|
...
N As you go... |AYG|43365| |N|Collect 10 (item:137119) from "Powering the Portal" missions, This mission will take up to 1 hour to complete each mission (52.71,51.06)| |Z|747| |QID|42049|
N Switch Guide |N|Switch to (guide:"713(10-45)") guide and complete to collect 25 (item:138993) from the enemies in the dungeon for the quest (qid:42719)| |QID|42719|
...
N As you go... |AYG|43403| |N|Collect 10 (item:137119) from "Powering the Portal" missions, This mission will take up to 1 hour to complete each mission (52.71,51.06)| |Z|747|  |QID|42049|
...
C Powering the Portal |QID|42049| |N|Collect 10 (item:137119) from "Powering the Portal" missions, This mission will take up to 1 hour to complete each mission (52.71,51.06)| |Z|747| 
