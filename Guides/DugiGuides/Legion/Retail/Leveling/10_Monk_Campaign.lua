...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "MONK", "L", nil, function()
return [[
...
C Scrolls of Knowledge |QID|42210| |N|Use the Scouting Map and complete the mission (mission:887). This is a 1 hour mission| |Z|709|
...
----
N Switch Guide |N|Switch to (guide:"1041(10-50)") and complete it for the quest (qid:41040)| |QID|41040|
