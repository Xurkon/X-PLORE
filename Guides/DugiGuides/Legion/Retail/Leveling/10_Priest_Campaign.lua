...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "PRIEST", "L", nil, function()
return [[
...
T Return of the Light |QID|42074| |N|(npc:101313) at the {Antonidas Memorial} (47.74,47.52)| |Z|627| |NPC|101313| |POI| |PRE|41957|
...
C Troops in the Field |QID|43276| |N|Use the Holographic Map and complete the mission, (mission:1213). This is a 1 hour mission| |Z|702| |POI|
...
N Switch Guide |N|Switch to (guide:"713(10-45)") and complete it to kill (npc:96028) for the quest (qid:43378)| |QID|43378|
...
N Switch Guide |N|Switch to (guide:"703(10-45)") and complete it to kill (npc:96646) and collect (item:139485) for the quest (qid:43377)<br/><br/>Make sure you complete the entire dungeon| |QID|43377|
...
N (item:143778) |QID|45564.1| |N|Collect 5 (item:143778) in {Highmountain} (35.74,23.98)| |Z|650| |CHOICE|3|
