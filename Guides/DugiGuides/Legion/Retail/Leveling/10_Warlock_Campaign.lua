...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "WARLOCK", "L", nil, function()
return [[
...
C Troops in the Field |QID|42602| |N|Use the Dreadscar Battle Plans and complete the mission (mission:1213). This is a 1 hour mission so come back later to complete this quest| |Z|717| |NPC|101097| |POI|
...
----
N Switch Guide |N|Switch to (guide:"751(10-45)") guide to kill (npc:98542) and collect (item:138988) for the quest (qid:42098)| |QID|42098|
...
N Switch Guide |N|Switch to (guide:"710(45-50)") and collect a (item:138989) from (npc:95888) for the quest (qid:42660)| |QID|42660|
...
K (npc:116497) |QID|45524.2| |N|Kill (npc:116497) in {Stormheim} (74.19,85.03)| |Z|634| |NPC|116497| |CHOICE|1|
...
N (item:143778) |QID|45564.1| |N|Collect 5 (item:143778) in {Highmountain} (35.74,23.98)| |Z|650| |CHOICE|2|
...
A Answers Unknown |QID|45021| |N|(npc:105926) in {Broken Shore}  (57.16,38.22)| |Z|717| |NPC|105926|
...
N (npc:108018) |QID|46784.1| |N|Speak to (npc:108018) in {Dreadscar Rift} (55.34,40.98)| |Z|717| |NPC|108018|
