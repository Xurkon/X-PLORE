...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "WARRIOR", "L", nil, function()
return [[
...
C Troops in the Field |QID|42610| |N|Use the Eye of Odyn and complete the mission, (mission:927). This is a 1 hour mission| |Z|695| |POI|
...
N Switch Guide |N|Switch to (guide:"706(45-50)") and complete it to defeat (npc:107989) and (npc:91387)| |QID|43604|
...
N Switch Guide |N|Switch to (guide:"751(10-45)") and complete it to kill (npc:98970) and collect (item:139453) for the quest (qid:43506)| |QID|43506| 
