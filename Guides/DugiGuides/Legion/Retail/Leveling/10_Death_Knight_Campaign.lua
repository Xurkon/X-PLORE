...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Legion|r", "Class Campaign (10-50)", nil, nil, "DEATHKNIGHT", "L", nil, function()
return [[
...
C Troops in the Field |QID|43267| |N|Use the Scouting map and complete the mission, (mission:901). This is a 1 hour mission (49.81,51.35)| |Z|648| |NPC|93568|
...
N Switch Guide |QID|43571| |N|Switch to (guide:"731(10-45)") to kill (npc:99460) and collect (item:139537) for the quest (qid:43571)| 
...
N Switch Guide |QID|43572| |N|Switch to (guide:"733(10-45)") to kill (npc:99192) and collect (item:139538) for the quest (qid:43572)| 
...
N Switch Guide |N|Switch to (guide:"710(45-50)") guide and to complete the quest (qid:44286)| |QID|44286|
...
N Switch Guide |N|Switch to (guide:"706(45-50)") guide to complete the quest (qid:43574)| |QID|43574|
...
N Switch Guide |N|Switch to (guide:"713(10-45)") to complete the quest (qid:44282)| |QID|44282|
