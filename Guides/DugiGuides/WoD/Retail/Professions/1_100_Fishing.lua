local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_En_Fishing_Draenor")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Leveling|r", "Draenor Fishing 1-100", nil, nil, nil, "P", nil, function()
return [[
...
N Note... |N|Any of these routes will allow you to level from 1 to 100, so if you get bored of one are, you can move to another route. Remeber to click the green button next to the route step to reset the route. Tick this step.| |P|1100 100|

U (item:111356) |N|This is fished up in waters around Draenor.| |U|111356| |P|1100 1|
...
end, {description = [[This guide covers how to level up the Draenor Fishing profession from 1-100]]})	
	end
