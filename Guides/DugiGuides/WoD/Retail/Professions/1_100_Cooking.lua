local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_En_Cooking_WoD")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Leveling|r", "Draenor Cooking 1-100", nil, nil, nil, "P", nil, function()
return [[

N Read First |N|You must have a character Level 40+ and Warlords of Draenor is required. <br/><br/>Leveling is available in Draenor from 1-100. <br/><br/>Tick this step.|
N Cooking Recipes |N|Cooking recipes are learned from creating consumable items, so if a particular recipe is not available, continue cooking Draenor recipes until you learn it. Tick this step.|
