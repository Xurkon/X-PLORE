...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor|r", "534(40+)#534(40+)#534(40+)", nil, "Alliance", nil, "D", nil, function()
return [[
...
end, {image = "tanaanjungle.tga", description = [[This guide unlocks Tanaan Jungle and Garrison Naval Missions. Level 40 character and tier 3 Garrison]]})	end
