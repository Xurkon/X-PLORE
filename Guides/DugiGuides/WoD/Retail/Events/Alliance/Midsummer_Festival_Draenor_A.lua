...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Midsummer Festival|r ", "Midsummer Festival Draenor (35+)", nil, "Alliance", nil, "E", "|SG|DugisGuideViewer.SuggestCurrentHolidayPredicate([[Calendar_Midsummer]])|", function() 
return [[
...
A Honor the Flame |QID|44573| |N|(npc:114491) in {Gorgrond} (43.9,93.7)| |NPC|114491| |Z|543|
