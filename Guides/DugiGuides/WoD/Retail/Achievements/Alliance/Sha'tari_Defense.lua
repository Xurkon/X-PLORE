...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Sha'tari Defense (40+)", nil, "Alliance", nil, "A", nil, function()
return [[
...
K NPC's around Shattrath City |N|Kill Level 40 NPC's (42.7,33.0) around {Shattrath City}| |Z|535|
