...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "The Saberstalkers (40+)", nil, "Alliance", nil, "A", nil, function()
return [[

N Pre-quest Required |N|Complete the (guide:"534(40+)#534(40+)#534(40+)") guide section to unlock the daily quest| |QID|38445|
A Tooth and Claw |QID|39582| |N|(npc:96147) in {Lion's Watch} (57.84, 59.79)<br/><br/>This quest may not be available, tick this step.| |D| |Z|534| |NPC|96147|
