...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Wrynn's Vanguard (40+)", nil, "Alliance", nil, "A", nil, function()
return [[
...
N (fac:1682) QuarterMaster |N|(npc:80882) (44.2,74.0) in {Stormshield}| |NPC|80882| |Z|624| --Crafticus Mindbender
