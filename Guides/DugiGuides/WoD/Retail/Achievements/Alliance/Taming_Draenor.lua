...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Battle Pets|r ", "Taming Draenor (35+)", nil, "Alliance", nil, "A", nil, function()
return [[
...
R Nagrand |N|Travel to {Nagrand} (56.2,09.8)| |AID|9724| |AC|3| |Z|550|
N (npc:87110) |N|Defeat (npc:87110) in a Pet Battle (56.2,09.8). 3 Level 25 Pets: 3 Humanoid -->Use Undead | |NPC|87110| |AID|9724| |AC|3| |Z|550| --Tarr the Terrible 
