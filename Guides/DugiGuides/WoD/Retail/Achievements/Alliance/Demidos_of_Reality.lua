...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Quests|r ", "A Demidos of Reality (40+)", nil, "Alliance", nil, "A", nil, function()
return [[

N Note |N|Defeat Demidos, Devourer of Lights in Socrethar's Rise for (aid:9437). Tick this step.|

K Demidos |N|Slay (npc:84911) (46.0,71.7). (npc:84911) is a Rare Elite| |NPC|84911| |AID|9437| |Z|539|
