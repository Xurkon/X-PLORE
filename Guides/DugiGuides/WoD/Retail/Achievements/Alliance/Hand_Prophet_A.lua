...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Hand of the Prophet (40+)", "Tanaan Jungle (Daily)", "Alliance", nil, "A", nil, function()
return [[
