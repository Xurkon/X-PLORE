...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Council of Exarchs (40+)", nil, "Alliance", nil, "A", nil, function()
return [[
...
N (map:539) |N|Switch to the (guide:"539(10-40)#539(10-40)#539(10-40)") guide and complete all quests in (map:539)| |QID|33256|
