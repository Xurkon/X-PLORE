...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Arakkoa Outcasts (40+)", nil, "Horde", nil, "A", nil, function()
return [[
...
N (map:535) |N|Switch to the (guide:"535(20-40)#535(20-40)#535(20-40)") Guide and complete all quests in (map:535)| |QID|33884|
N (map:542) |N|Switch to the (guide:"542(30-40)#542(30-40)#542(30-40)") Guide and complete all quests in (map:542)| |QID|35704|
...
K NPCs around Skettis |N|Kill (npc:85542), (npc:84467), (npc:84083), and (npc:89085) (56.9,11.7) around {Skettis}| |NPC|85542,84467,84083,89085| |Z|542| --Skyreach Labormaster, Skyreach Tempest-Keeper, Dread Raven, Flighted Storm-Spinner
...
N (fac:1515) Quartermaster |N|(npc:86037) in (53.6,62.0) in {Warspear}| |NPC|86037| |Z|624|
