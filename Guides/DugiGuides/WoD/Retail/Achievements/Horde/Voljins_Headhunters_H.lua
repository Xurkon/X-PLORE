...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Vol'jin's Headhunters (40+)", "Tanaan Jungle (Daily)", "Horde", nil, "A", nil, function()
return [[
