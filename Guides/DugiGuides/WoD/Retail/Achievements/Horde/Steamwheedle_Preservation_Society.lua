...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Steamwheedle Preservation Society (40+)", nil, "Horde", nil, "A", nil, function()
return [[
...
N Note |N|These NPC's are Level 40 elite. The items they drop can be used for reputation gains, and can be looted over and over. <br/><br/>If the NPC is not present at the location listed, it might have recently been killed, tick the step to move to the next NPC. <br/><br/>Tick this step.|
...
N (fac:1711) Quartermaster |N|(npc:88493) (53.8,60.8) in {Warspear}| |NPC|88493| |Z|624|
