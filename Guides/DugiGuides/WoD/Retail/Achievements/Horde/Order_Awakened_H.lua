...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Order of the Awakened (40+)", nil, "Horde", nil, "A", nil, function()
return [[

N Pre-quest Required |N|Complete the (guide:"534(40+)#534(40+)#534(40+)") guide section to unlock the daily quest| |QID|37935|
