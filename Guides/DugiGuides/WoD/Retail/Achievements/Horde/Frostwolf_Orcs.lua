...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor Reputation|r ", "Frostwolf Orcs (40+)", nil, "Horde", nil, "A", nil, function()
return [[
...
N (map:525) |N|Switch to the (guide:"525(10-40)#525(10-40)#525(10-40)") Guide and complete all quests in (map:525)| |QID|37563|
