...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Cataclysm|r ", "198(30-35)#198(30-35)#198(30-35)", "207(30-35)#207(30-35)#207(30-35)", "Alliance", nil, "L", nil, function()
return [[
...
N Activate Crucible of Fire |QID|25303.3| |N|Activate the devices in this order:<br/><br/>1.Fire<br/>2.Earth<br/>3.Air<br/>4.Water<br/><br/> Doing so will spawn a mob that you must kill in {Gar'gol's Hovel} (25.94, 41.80)| |NPC|39730, 39756|
...
R Lightning Ledge |N|Use to portal to return to {Lightning Ledge} (25.91, 40.96)| |QID|25352| |WR|
...
f Shrine of Aviana |N|Grab the flight path for {Shrine of Aviana} from (npc:50084) (41.18, 42.60)| |QID|25663| |NPC|50084| 
...
f Grove of Aessina |N|Grab the flight path for {Grove of Aessina} from (npc:41860) (19.58, 36.40)| |QID|25404| |NPC|41860| 
...
N (item:55137) |N|Put on the (item:55137) at the outhouse in {Darkwhisper Gorge} (77.48, 48.12)| |U|55137| |QID|25308| |BUFF|306868|
...
N (npc:40934) |N|Mount an (npc:40934) (72.50, 75.00)| |QID|25608.1| |NPC|40934| |V|
