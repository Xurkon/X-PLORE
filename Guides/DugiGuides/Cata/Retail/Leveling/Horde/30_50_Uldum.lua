...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Cataclysm|r ", "249(30-35)#249(30-35)#249(30-35)", "241(30-35)#241(30-35)#241(30-35)", "Horde", nil, "L", nil, function()
return [[
...
C The Pit of Scales |QID|27738.1| |N|Clear the area around the prisoner in {The Pit of Scales} before talking to him. Then Caimas an elite will appear sending 3 crocodiles at you one at a time, they're easily killed. When he attacks you, have him run over the Croc Eggs that spawn to slow him down and deal some damage. (58.27, 83.27)| |NPC|46496, 46276|
...
f Schnottz's Landing |N|Grab the flight path for {Schnottz's Landing} from (npc:48273) (22.31, 64.88)| |QID|27939| |NPC|48273| 
