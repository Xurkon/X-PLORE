...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Quests|r ", "Wildhammer Tour of Duty (30+)", nil, "Alliance", nil, "A", nil, function()
return [[

N Please Read! |N|The mobs that you will encounter come in packs of 2-4, so being under 84 in not advisable. Tick this step.|
