...
N (aid:1243) |N|After you reach fishing Level 40, watch for (item:34109). This is found in random trunks and crates fished from pools.| |AID|1516| |AC|12|

h Valley of Strength |N|(npc:6929) (53.7, 78.8) Make {Orgrimmar} your home| |Z|85| |NPC|6929|
...
R Vashj'ir |N|Take portal in {Orgrimmar} (45.0, 27.6)| |Z|201| |AID|5479| |AC|1|
N (item:52340) |T| |N|Drop from humanoid mobs in {Kelp'thar Forest}-{Vashj'ir} (45.0, 27.6)| |Z|201| |AID|5479| |AC|1|

R Orgrimmar |N|Travel to {Orgrimmar} (53.7, 78.8)| |Z|85| |AID|5479|
N (item:6291) |FIS| |LOOP| |N|Fish until you have caught one of these. Fished in Open Waters (65.2, 43.1)| |Z|85| |AID|5478| |AC|8|
N (item:6289) |FIS| |LOOP| |N|Fish until you have caught one of these. Fished in Open Waters (65.2, 43.1)| |Z|85| |AID|5478| |AC|23|
N (item:6308) |FIS| |LOOP| |N|Fish until you have caught one of these. Fished in Open Waters (65.2, 43.1)| |Z|85| |AID|5478| |AC|21|

R Deepholm |N|Travel to {Deepholm} (70.7, 49.1)| |Z|207| |AID|5478| |AC|29|
...
R Azshara |N|Travel to {Azshara} (50.0, 50.0)| |Z|76| |AID|5479|
...
R Mount Hyjal |N|Travel to {Mount Hyjal} (63.1, 27.1)| |Z|198| |AID|5478|
...
R Northern Barrens |N|Travel to {Northern Barrens} (56.6, 80.0)| |Z|10| |AID|5478|
...
R Stormwind City |N|Travel to {Stormwind City} (75.9, 81.5). PVP ALERT! You will be flagged PVP on a PVE server.| |Z|84| |AID|1516| |AC|4|
N The Fishing Diplomat |FIS| |LOOP| |N|Fish something up in {Stormwind City} (75.9, 81.5). As long as you are inside the city, you will get credit for this achievement. PVP ALERT! If you are not on a PVP server, entering a capital city of the opposing faction will flag you PVP.| |Z|84| |AID|1516| |AC|4|

R Deadwind Pass |N|Travel to {Deadwind Pass} (42.9, 29.3)| |Z|42| |AID|5478|
...
R Blasted Lands |N|Travel to {Blasted Lands} (48.0, 83.7)| |Z|17|
...
N (item:13760) |FIS| |LOOP| |N|Fished from inland open waters in {Blasted Lands}. Can only be caught "during the day", so try fishing for these from 6am-6pm server time. (44.0, 64.9)(44.1, 72.2)(43.3, 81.5)(48.0, 83.7)| |Z|17| |AID|5479| |AC|24|
...
R Hellfire Peninsula |FIS| |LOOP| |N|Travel through the Dark Portal to {Hellfire Peninsula} (44.6, 30.8)| |Z|100|
...
R Isle of Quel'Danas |N|Take portal in {Shattrath} to {Isle of Quel'Danas} (45.8, 20.8)| |Z|122| |AID|5479| |AC|7|
...
R Borean Tundra |N|Travel to {Borean Tundra} (52.7, 48.8)| |Z|114|
...
end, {description = [[This is the huge fishing meta achievement guide which awards you the {Salty} title, plus (aid:5478) and (aid:5479). <br/><br/>There are several achievements required to do this, so this guide will try and go thru them step by step. <br/><br/>This guide will also utilize other Daily guides as well. There is a lot of travel involved in this guide, but once you have fished all the available fish/items in a zone, then you won't have to come back to that zone. <br/><br/>Lets get started.]]})
	end
