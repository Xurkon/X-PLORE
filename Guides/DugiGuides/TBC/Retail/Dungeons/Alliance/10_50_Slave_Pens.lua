...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "265(10-50)", "262(10-50)", "Alliance", nil, "I", nil, function()
return [[

R The Slave Pens |N|Use your dungeon finder to queue for Steamvault or enter from {Coilfang Reservoir} in {Zangarmarsh}. You need to swim down and through the Reservoir to reach the entrance (18.84, 11.34)| |I| |Z|265| |F|265|
