...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Midsummer Festival|r ", "Midsummer Festival Outland (30+)", nil, "Alliance", nil, "E", "|SG|DugisGuideViewer.SuggestCurrentHolidayPredicate([[Calendar_Midsummer]])|", function() 
return [[
...
A Honor the Flame (Nagrand) |N|Telaar (49.6, 69.5)| |Z|107| |QID|11821| |E|
A Desecrate this Fire! (Nagrand) |N|Garadar (51.1, 34.2)| |Z|107| |QID|11778| |E|
