...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "The Consortium Reputation (25+)", nil, "Alliance", nil, "A", nil, function()
return [[
...
A The Horrors of Pollution |N|Starts from (item:29738).| |QID|10413| |U|29738| |Z|109|
...
T The Horrors of Pollution |N|(npc:20449) (59.3, 32.5)| |QID|10413| |Z|109| |NPC|20449|
