...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Kurenai Reputation (25+)", nil, "Alliance", nil, "A", nil, function()
return [[

N Please Read! |N|This guide will go over all the quest needed to get Exalted with (fac:978). <br/><br/>Once all the quest are done for a particular faction, then is just grinding out the repeatable dungoens/turn-ins to get to Exalted|
...
C The Ravaged Caravan |N|Get 10 (item:25647) around the waypoint (23, 28). There are two Elites roaming around the entrance to the hill. If you wait for them to path, they will engage the Warmaul Ogres. You can either pass them or get the crates on the path| |QID|9956| |Z|107| |OBJ|6881|
