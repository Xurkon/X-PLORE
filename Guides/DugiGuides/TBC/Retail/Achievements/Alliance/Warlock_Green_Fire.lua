...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Quests|r ", "Warlock Green Fire Quest Line (35+)", nil, nil, "WARLOCK", "A", nil, function()
return [[

N Required |N|You will need to be level 35+ to complete this guide.| |PL|35|
