...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Netherwing Neutral-Honored (25+ Dailies)", "Netherwing Revered-Exalted (25+ Dailies)", "Alliance", nil, "A", nil, function()
return [[
...
end, {description = [[You need to complete the (guide:"Netherwing (25+ Pre-Quest)") guide first before you can begin this guide to aquire Neutral-Honored for the (fac:1015) Faction.]]})	
	end
