...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Sha'tari Skyguard Reputation (15+)", nil, "Alliance", nil, "A", nil, function()
return [[
...
C Threat from Above |N|Slay any 20 Gordunni Ogres in the Barrier Hills (22.0, 13.0)| |QID|11096| |Z|108| |NPC|22143, 22144, 22148, 23022|
...
C World of Shadows |N|Retrieve 6 (item:32388) from the Arakkoa (69.9, 82.1)| |QID|11004| |Z|108| |NPC|21644, 21649, 21650, 21911|
C Hungry Nether Rays |N|Use the Nether Ray Cage in the woods south of {Blackwind Landing} and slay (npc:23219)s (67.2, 72.8)(64.6, 85.5)| |QID|11093| |U|32834| |Z|108| |NPC|23219|
...
K (npc:23068) |N|Found near (70.0, 74.4)| |QID|11005.3| |Z|108| |NPC|23068|
K (npc:23066) |N|Found near (69.1, 78.5)| |QID|11005.1| |Z|108| |NPC|23066|
A Ishaal's Almanac |N|Loot (item:32523) from Ishaal| |U|32523| |QID|11021| |NPC|23066|
K Talonpriest Skizzik |N|Found near (69.9, 82.1)| |QID|11005.2| |Z|108| |NPC|23067|
...
U (item:32741) |N|Use the (item:32741). Tick this step| |QID|11029| |U|32741| |Z|108|
B (npc:23363) |N|(npc:23363) (67.0, 79.7)| |QID|11029| |Z|108| |NPC|23363|
...
N (item:32620) |T| |N|Collect 40 (item:32620) from Time-Lost mobs in {Skettis}. These mobs are visible when (item:32446) is used. (61, 75)(69, 85)(76, 81)(69, 75)| |L|32620 40| |QID|11885| |Z|108| |NPC|21787, 21651, 21763|
C Adversarial Blood |N|Summon and defeat each of the 4 descendants by using 10 Time-Lost Scrolls per descendant at the Skull Pile. (62.0, 74.7)(57.1, 83.7)(70.0, 83.3)(69.6, 74.8)| |QID|11885| |Z|108| |NPC|23161, 23165, 23163, 23204|
...
end, {description = [[This guide covers how to gain reputation with (fac:1031)]]})
	end
