...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Sha'tari Skyguard / Ogri'la (25+ Dailies)", nil, "Alliance", nil, "A", nil, function()
return [[
...
end, {description = [[This guide covers daily quests associated with (fac:1031)]]})
	end
