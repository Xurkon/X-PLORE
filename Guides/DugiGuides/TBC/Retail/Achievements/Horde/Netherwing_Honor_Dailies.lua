...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Netherwing Neutral-Honored (25+ Dailies)", "Netherwing Revered-Exalted (25+ Dailies)", "Horde", nil, "A", nil, function()
return [[

N Pre-quest Reguired |N|You need to complete the (guide:"Netherwing (25+ Pre-Quest)") guide first before you can begin this guide.| |QID|10870|
