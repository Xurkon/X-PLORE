...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "The Aldor Reputation (15+)", nil, "Horde", nil, "A", nil, function()
return [[
...
R Shattrath City |N|Travel to {Shattrath City} (24.2, 29.5)| |Z|111| |QID|10410|
...
R Shadowmoon Valley |N|Travel to {Shadowmoon Valley} (45.3, 34.9)| |Z|104| |QID|10646|
