...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Sporeggar Reputation (10+)", nil, "Horde", nil, "A", nil, function()
return [[

N Please Read! |N|This guide will go over all the quests needed to get the Diplomat (Exalted with (fac:576), (fac:941) and (fac:970)). <br/><br/>Once all the quests are done for a particular faction, then is just grinding out the repeatable dungeons/turn-ins to get to Exalted. <br/><br/>Tick this step.|
N Low Level Quests |N|Make sure you are traking low level quests to make it easier to see the quests givers.|

R Zangarmarsh |N|Travel to {Zangarmarsh} (82, 93)| |Z|102|
...
N Friendly - Sporeggar |N|Complete every repeatable you can until you're friendly. You can turn in (item:24245), (item:24291) and (item:24290). All these repeats end once you're friendly, so use them while you can!| |QID|9726| |Z|102|
