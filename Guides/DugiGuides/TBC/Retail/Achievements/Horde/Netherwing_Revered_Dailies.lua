...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Netherwing Revered-Exalted (25+ Dailies)", nil, "Horde", nil, "A", nil, function()
return [[
...
C Disrupting the Twilight Portal |QID|11086| |N|Kill 20 Deathshadow Agent (12.7, 38.9)| |D| |NPC|23139| |NPC|22393, 22363, 22342, 22343, 22341| |REP|1015, 6| |Z|107|
...
end, {description = [[You need to complete the (guide:"Netherwing (25+ Pre-Quest)") guide first before you can begin this guide to aquire Revered-Exalted for the (fac:1015) Faction.]]})
	end
