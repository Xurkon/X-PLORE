...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Shattered Sun Offensive Reputation (35+)", nil, "Horde", nil, "A", nil, function()
return [[

N Note |N|This guide covers the quests required to obtained exalted with (fac:1077). Alot of these quests are daily quests. <br/><br/>Exalted status rewards (aid:897). (item:35221) is also avaialble at exalted<br/><br/> Tick this step.|
