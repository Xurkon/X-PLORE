local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_ShatteredSun_Phase2_2")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("TBC Dailies", "Shattered Sun (P2 Capturing Armory, Portal Activated)", nil, nil, nil, "D", nil, function()
return [[
...
N Take a Flight to the Dead Scar |QID|11532| |N|Speak to (npc:25059) and take a flight to the Dead Scar (48.51,25.22)| |D| |O| |Z|122| |NPC|25059| |V|
...
end, {description = [[This guide section will walk you through the Shattered Sun Offensive daily quests during phase 2 after the portal is activated]]})
	end
