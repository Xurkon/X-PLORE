local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Shattrath_Fishing")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Profession", "Shattrath Fishing (Daily)", nil, nil, nil, "D", nil, function()
return [[
