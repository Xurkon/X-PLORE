local Guide = DugisGuideViewer:RegisterModule("DugisGuide_BC_Daily_Cooking")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Profession", "Shattrath Cooking (Daily)", nil, nil, nil, "D", nil, function()
return [[
