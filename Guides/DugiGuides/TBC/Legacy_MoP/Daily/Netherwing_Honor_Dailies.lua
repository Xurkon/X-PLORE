...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("TBC Dailies", "Netherwing (Neutral-Honored Daily)", "Netherwing (Revered-Exalted Daily)", nil, nil, nil, "D", nil, function()
return [[
