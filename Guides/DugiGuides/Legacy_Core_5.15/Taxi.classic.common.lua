...
local GetSpellBookItemInfo, GetSpellInfo, IsUsableSpell, GetSpellCooldown = 
	GetSpellBookItemInfo, GetSpellInfo, IsUsableSpell, GetSpellCooldown
local select = select
...
--DGV:DebugFormat("BacktrackCharacterPath", "mTrans", mTrans, "fTrans", fTrans, "resultX", resultX, "resultY", resultY, "recursiveResult", recursiveResult)
	...
	local dragonisle = 1978
	local groundedMaps = {122, 95, 94, 110, 106, 97, 103, 244, 245, 338, 504, 554,
    830, 882, 885
    }
	local spellFlightMastersLicense = GetSpellBookItemInfo(GetSpellInfo(90267))
	local spellColdWeatherFlying = GetSpellBookItemInfo(GetSpellInfo(54197))
	local spellWisdomOfTheFourWinds = GetSpellBookItemInfo(GetSpellInfo(115913))
