...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Northrend|r ", "130(25-30)", nil, "Alliance", nil, "I", nil, function()
return [[

R The Culling of Stratholme |N|Queue for {The Culling of Stratholme} using your dungeon finder or enter the instance from Cavern of Time in {Tanaris} (86.4, 61.6))| |I| |Z|130| |F|130|
