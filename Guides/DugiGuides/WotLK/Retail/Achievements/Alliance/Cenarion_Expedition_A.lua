...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Burning Crusade Reputation|r ", "Cenarion Expedition Reputation (25+)", nil, "Alliance", nil, "A", nil, function()
return [[
