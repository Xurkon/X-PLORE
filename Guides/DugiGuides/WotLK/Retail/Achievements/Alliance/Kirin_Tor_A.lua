...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Wrath of the Lich King Reputation|r ", "Kirin Tor Reputation (10+)", nil, "Alliance", nil, "A", nil, function()
return [[

N Please Read! |N|This guide will go over all the quests that give rep with (fac:1090). <br/><br/>Once all the quests are done, then is just grinding out the repeatable dungeons/turn-ins to get to Exalted. Tick this step.|
