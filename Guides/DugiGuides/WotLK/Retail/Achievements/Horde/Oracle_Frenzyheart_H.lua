...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Wrath of the Lich King Reputation|r ", "Oracle/Frenzyheart Reputation (30+)", nil, "Horde", nil, "A", nil, function()
return [[
