...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Wrath of the Lich King Reputation|r ", "The Kalu'ak Reputation (30+)", nil, "Horde", nil, "A", nil, function()
return [[
...
R Borean Tundra |N|Travel to {Borean Tundra} (32.3, 54.3)| |Z|114| |QID|11655|
A Into the Mist |N|(npc:25476) (32.3, 54.3)| |QID|11655| |NPC|25476| |Z|114|
A Horn of the Ancient Mariner |N|(npc:25476) (32.3, 54.3)| |QID|11660| |NPC|25476| |Z|114|
C Horn of the Ancient Mariner |QID|11660| |N|Keep killing (npc:25479)'s around the waypoint (29.0, 52.6) until the (item:34844) drops| |NPC|25479| |Z|114|
C Into the Mist |QID|11655| |N|Kill Kvaldir (29.0, 52.6) till you have enough (item:34814)| |NPC|25496, 25479| |Z|114|
T Into the Mist |N|(npc:25476) (32.3, 54.3)| |QID|11655| |NPC|25476| |Z|114|
A Burn in Effigy |N|(npc:25476) (32.3, 54.3)| |QID|11656| |NPC|25476| |Z|114|
T Horn of the Ancient Mariner |N|(npc:25476) (32.3, 54.3)| |QID|11660| |NPC|25476| |Z|114|
A Orabus the Helmsman |N|(npc:25476) (32.3, 54.3)| |QID|11661| |NPC|25476| |Z|114|
N Destroy Bor's Hammer |QID|11656.3| |N|Use the (item:34830) to burn the Kvaldir ships at {Pal'ea} and {Garrosh's Landing} (29.7, 52.9)| |U|34830| |Z|114|
N Destroy The Kur Drakkar |QID|11656.2| |N|Use the (item:34830) to burn the Kvaldir ships at {Pal'ea} and {Garrosh's Landing} (30.9, 48.9)| |U|34830| |Z|114|
N Destroy The Serpent's Maw |QID|11656.1| |N|Use the (item:34830) to burn the Kvaldir ships at {Pal'ea} and {Garrosh's Landing} (31.5, 48.3)| |U|34830| |Z|114|
C Orabus the Helmsman |QID|11661| |N|Summon (npc:32576) with the (item:34844) at the end off {Warsong Jetty} (26.6, 54.6), then kill him| |U|34844| |NPC|32576| |Z|114|
N Destroy Bor's Anvil |QID|11656.4| |N|Use the (item:34830) to burn the Kvaldir ships at {Pal'ea} and {Garrosh's Landing} (30.1, 61.6)| |U|34830| |Z|114|
T Burn in Effigy |N|(npc:25476) (32.3, 54.3)| |QID|11656| |NPC|25476| |Z|114|
T Orabus the Helmsman |N|(npc:25476) (32.3, 54.3)| |QID|11661| |NPC|25476| |Z|114|

T Seek Out Karuk! |N|(npc:25435) (47.2, 75.5)| |QID|11662| |NPC|25435| |Z|114|
...
C Planning for the Future |QID|11960| |N|Steal 12 (npc:26200)s north of town around the waypoint (45.7, 61.6)| |NPC|26200| |Z|115|
