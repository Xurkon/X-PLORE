...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Wrath of the Lich King Reputation|r ", "Kirin Tor Reputation (15+)", nil, "Horde", nil, "A", nil, function()
return [[

N Please Read! |N|This guide will go over all the quests that give rep with (fac:1090). <br/><br/>Once all the quests are done, then is just grinding out the repeatable dungeons/turn-ins to get to Exalted.|

R Borean Tundra |N|Travel to {Borean Tundra} (58.5, 67.8)| |QID|11575| |Z|114|
A Too Close For Comfort |N|Endorah (41.8, 54.7)| |QID|11574| |Z|114|
T Too Close For Comfort |N|Librarian Donathan (45.3, 33.5)| |QID|11574| |Z|114|
...
R The Nexus Instance |N|Queue for the {The Nexus} with your dungeon finder or find the instance in {Borean Tundra} (Bottom floor)(36.19, 83.09)| |QID|13095| |I| |WR| |Z|129|
A Have They No Shame? |QID|13095| |N|(npc:55537) (36.19, 83.09)| |NPC|55537| |Z|129|
...
C Have They No Shame? |N|Collect (item:43095) from the middle of {Hall of Stasis} (35.7, 81.7) (26.9, 67.9) (22, 66.2) (19.1, 52.1)| |QID|13095| |OBJ|8128| |Z|129|
...
T Have They No Shame? |QID|13095| |N|(npc:55537) (36.19, 83.09)| |NPC|55537| |Z|129|
...
C Rifle the Bodies |QID|11999| |U|35792| |N|Collect (item:35792) from the bodies around the waypoint (25.2, 58.9). Make sure you open the (item:35792) you loot from the corpses. The (item:35783) are in the bags| |Z|115| |NPC|26477|
T Rifle the Bodies |N|(npc:26471) (38.0, 46.3)| |QID|11999| |Z|115| |NPC|26471|
A Prevent the Accord |N|(npc:26471) (38.0, 46.3)| |QID|12005| |Z|115| |NPC|26471|
K (npc:26496) |QID|12005.1| |N|Kill (npc:26496) and collect (item:35800), {Moonrest Gardens} (18.40, 58.89)| |Z|115| |NPC|26496|
K (npc:26349) |QID|12005.2| |N|Kill (npc:26349) on the second level and collect (item:35801), {Moonrest Gardens} (18.84, 58.88) (19.46, 58.02)| |Z|115| |NPC|26349|
N (item:36742) |N|Collect (item:36742) from (npc:26349) (19.5, 58)| |QID|12059| |Z|115| |L|36742| |T| |NPC|26349|
T Prevent the Accord |N|(npc:26471) (38.0, 46.3)| |QID|12005| |Z|115| |NPC|26471|
...
U Use (item:36815) |N|Use (item:36815)| |U|36815| |QID|12122| |Z|115|
...
A The Magical Kingdom of Dalaran |N|(npc:26471) (38.0, 46.3)| |QID|12791| |Z|115| |NPC|26471|
R Dalaran |N|Travel to {Dalaran} (57.4, 46.5)| |QID|12791| |Z|125|
T The Magical Kingdom of Dalaran |N|(npc:29156) (57.4, 46.5)| |QID|12791| |Z|125| |NPC|29156|
...
end, {description = [[This guide will go over all the quests that give rep with (fac:1090)]]})
	end
