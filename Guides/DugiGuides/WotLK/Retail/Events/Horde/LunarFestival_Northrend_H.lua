...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Lunar Festival|r ", "The Lunar Festival: Elders of Northrend (30+)", nil, "Horde", nil, "E", "|SG|DugisGuideViewer.SuggestCurrentHolidayPredicate([[Calendar_LunarFestival]])|", function() 
return [[
...
R Borean Tundra |N|Travel to {Borean Tundra}, you can take the Zeppelin from {Orgrimmar} (42.9, 49.6)| |Z|114| |WR|
