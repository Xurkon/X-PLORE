...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Profession", "Dalaran Jewelcrafting (Daily)", nil, "Horde", nil, "D", nil, function()
return [[

R Dalaran |N|Travel to {Dalaran} (40.5, 35.2)| |Z|125|
