...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("Argent Tournament", "Argent Tournament (Aspirant Dailies)", nil, "Horde", nil, "D", nil, function()
return [[
...
C Learning The Reins |N|Equip the (item:46070) and mount the (npc:33842) found at (72.9, 18.9). Use the (spell:62544) ability on a (npc:33229) 5 times, using Defend constantly to keep 3 layers up. Refresh your mount then use the (spell:62575) ability on a (npc:33243) repeatedly until vulnerable then use the (spell:62575) ability on a (npc:33272) then use the (spell:63010) ability twice while its shield is down| |QID|13677| |U|46070| |Z|118| |D| |NPC|33842, 33229, 33243, 33272|
C Training In The Field |N|Kill any Scourge around (71.4, 37.9)| |QID|13676| |Z|118| |D| |NPC|31783, 31718|
C A Blade Fit For A Champion |O| |N|Apply the (item:44986) then /kiss the (npc:33224) around (60.5, 51.5) in {Grizzly Hills}. Reapply the lip balm before kissing each frog| |U|44986| |QID|13673| |Z|116| |D| |NPC|33224|

K (npc:33289) |N|Kill (npc:33289) around (55, 75.2) in {Crystalsong Forest} and loot his (item:45005) then tick this objective| |L|45005| |Z|127| |O| |D| |QID|13675| |NPC|33289|
C The Edge Of Winter |O| |N|Find (npc:33303) at (42.2, 19.7) in {Howling Fjord} and use (item:45005)| |U|45005| |QID|13675| |Z|117| |D| |NPC|33303|

N 4 (item:45000) |N|Collect 4 (item:45000) around (71, 74.5) in {Icecrown} then tick this objective| |L|45000 4| |Z|118| |O| |D| |T| |QID|13674| |OBJ|3231|
C A Worthy Weapon |O| |N|Use the (item:45000) inside the ring of floating objects and the (npc:33273) will appear (92.8, 25.4). The (item:44978) will spawn next to her after some dialogue. {Dragonblight}| |L|44978| |U|45000| |Z|115| |QID|13674| |D| |NPC|33273| |OBJ|8564|
