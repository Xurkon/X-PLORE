...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("WOTLK Reputation Dailies", "The Sons of Hodir (750 - 1950 +Rep)", nil, "Horde", nil, "D", nil, function()
return [[

R Dun Niffelem |N|Travel to {Dun Niffelem} in {The Storm Peaks} (64, 61)| |Z|120|
A Raising Hodir's Spear |N|(npc:30252) (64.8, 59.1), Honored| |QID|13001| |Z|120| |NPC|30252| |REP|1119, 6|
C Raising Hodir's Spear |N|Enter the cave at (55.9, 64.6) and collect 3 (item:42541) (54.7, 60.7) from the depths of {Hibernal Cavern} and 3 (item:42542) from the (npc:30260) in the {Valley of Ancient Winters}| |QID|13001| |Z|120| |OBJ|8247| |NPC|30260| |REP|1119, 6|
...
C Blowing Hodir's Horn |N|Kill 5 (npc:29974) and 5 (npc:30144) at {Thunderfall} (71, 52) Then use (item:42164) over their corpses| |U|42164| |QID|12977| |Z|120| |D| |NPC|29974, 30144|
K Kill Brittle Revenant |N|Kill (npc:30160) and collect 6 (item:42246) (70, 59)| |L|42246 6| |Z|120| |NPC|30160|
