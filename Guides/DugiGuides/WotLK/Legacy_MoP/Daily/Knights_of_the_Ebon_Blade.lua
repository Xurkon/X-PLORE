...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("WOTLK Reputation Dailies", "Knights of the Ebon Blade (1500 +Rep)", nil, "Horde", nil, "D", nil, function()
return [[

R The Shadow Vault |N|Fly to {The Shadow Vault} (43.1, 24.2)| |Z|118|
A (npc:30216) Like Fire! |N|(npc:30216) (43.5, 24.5)| |QID|13071| |Z|118| |D| |NPC|30216|
...
C Shoot 'Em Up |N|Go to (32, 24) and choose one of the (npc:30337). Wait until the (npc:30330) fly nearby, if you need more than ~5 shots and they don't die, then they aren't close enough| |QID|13069| |Z|118| |D| |NPC|30337, 30330|
C Leave Our Mark |N|Kill the Vykuls (30, 28) and use (item:42480) on the corpses| |U|42480| |QID|12995| |Z|118| |D| |NPC|29880, 30243|
C (npc:30216) Like Fire! |N|Go to (27, 39) and mount a (npc:30272), and burn 8 buildings in the area| |QID|13071| |Z|118| |D| |NPC|30272|
T Shoot 'Em Up |N|(npc:30074) (43.6, 25.1)| |QID|13069| |Z|118| |D| |NPC|30074|
T (npc:30216) Like Fire! |N|(npc:30216) (43.5, 24.5)| |QID|13071| |Z|118| |D| |NPC|30216|
