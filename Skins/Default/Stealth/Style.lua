-- Skins\Default\Stealth\Style.lua
local ADDON_NAME, ADDON_TABLE = ...
local XP = ADDON_TABLE.XP
if not XP or not XP.Skins or not XP.Skins["default"] or not XP.Skins["default"].styles["stealth"] then
    return
end

local STYLE = XP.Skins["default"].styles["stealth"]
...
STYLE.TitleButtonsTexture = STYLEDIR .. "titlebuttons-thick"
STYLE.CheckRadioTexture = STYLEDIR .. "checkradio-thick"
STYLE.FloatingButtonsTexture = STYLEDIR .. "floatingbuttons-thick"
